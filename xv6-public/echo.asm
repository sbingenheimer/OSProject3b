...
main(int argc, char *argv[])
{
  ...
  5b:	6a 01                	push   $0x1
  5d:	e8 7e 04 00 00       	call   4e0 <printf>
  62:	83 c4 10             	add    $0x10,%esp
  exit();
  65:	e8 0b 03 00 00       	call   375 <exit>
  6a:	66 90                	xchg   %ax,%ax
  6c:	66 90                	xchg   %ax,%ax
  6e:	66 90                	xchg   %ax,%ax
 ...
 199:	31 db                	xor    %ebx,%ebx
{
 ...
 1a5:	57                   	push   %edi
 1a6:	6a 00                	push   $0x0
 1a8:	e8 e0 01 00 00       	call   38d <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 20d:	e8 a3 01 00 00       	call   3b5 <open>
  if(fd < 0)
 ...
 221:	50                   	push   %eax
 222:	e8 a6 01 00 00       	call   3cd <fstat>
  close(fd);
 227:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 22a:	89 c6                	mov    %eax,%esi
  close(fd);
 22c:	e8 6c 01 00 00       	call   39d <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 2cb:	e8 40 04 00 00       	call   710 <malloc>
  if (stackspace == NULL){
 2d0:	83 c4 10             	add    $0x10,%esp
 2d3:	85 c0                	test   %eax,%eax
 2d5:	74 28                	je     2ff <thread_create+0x3f>
    return -1;
  }
  void * stack;
 ...
 2d7:	a9 ff 0f 00 00       	test   $0xfff,%eax
 2dc:	75 1a                	jne    2f8 <thread_create+0x38>
  }else{
 ...
 2de:	50                   	push   %eax
 2df:	ff 75 10             	push   0x10(%ebp)
 2e2:	ff 75 0c             	push   0xc(%ebp)
 2e5:	ff 75 08             	push   0x8(%ebp)
 2e8:	e8 28 01 00 00       	call   415 <clone>
 ...
 2f2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    stack = stackspace + (PGSIZE - ((uint)stackspace - PGSIZE));
 2f8:	b8 00 20 00 00       	mov    $0x2000,%eax
 2fd:	eb df                	jmp    2de <thread_create+0x1e>
}
 2ff:	c9                   	leave  
    return -1;
...
int thread_join() {
 ...
 319:	50                   	push   %eax
 31a:	e8 fe 00 00 00       	call   41d <join>
    return toret;
  }
  else{
    return -1;
 ...
 43c:	89 d1                	mov    %edx,%ecx
{
 ...
 469:	0f b6 92 70 08 00 00 	movzbl 0x870(%edx),%edx
 ...
 4ae:	56                   	push   %esi
 4af:	57                   	push   %edi
 4b0:	e8 e0 fe ff ff       	call   395 <write>
  while(--i >= 0)
 ...
 4e9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 525:	57                   	push   %edi
 526:	56                   	push   %esi
 527:	e8 69 fe ff ff       	call   395 <write>
 ...
 559:	ff 24 85 18 08 00 00 	jmp    *0x818(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 57e:	e8 12 fe ff ff       	call   395 <write>
        putc(fd, c);
 ...
 58f:	57                   	push   %edi
 590:	56                   	push   %esi
 591:	e8 ff fd ff ff       	call   395 <write>
        putc(fd, c);
 ...
 5fb:	57                   	push   %edi
 5fc:	56                   	push   %esi
 5fd:	e8 93 fd ff ff       	call   395 <write>
        while(*s != 0){
 ...
 63c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 63f:	e8 51 fd ff ff       	call   395 <write>
        ap++;
 ...
 667:	90                   	nop
          s = "(null)";
 668:	ba 11 08 00 00       	mov    $0x811,%edx
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 773:	e8 85 fc ff ff       	call   3fd <sbrk>
  if(p == (char*)-1)
