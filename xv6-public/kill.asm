...
main(int argc, char **argv)
{
  ...
  39:	e8 37 03 00 00       	call   375 <kill>
  for(i=1; i<argc; i++)
  3e:	83 c4 10             	add    $0x10,%esp
  41:	39 de                	cmp    %ebx,%esi
  43:	75 e3                	jne    28 <main+0x28>
  exit();
  45:	e8 fb 02 00 00       	call   345 <exit>
    printf(2, "usage: kill pid...\n");
  4a:	50                   	push   %eax
  4b:	50                   	push   %eax
  4c:	68 d8 07 00 00       	push   $0x7d8
  51:	6a 02                	push   $0x2
  53:	e8 58 04 00 00       	call   4b0 <printf>
    exit();
  58:	e8 e8 02 00 00       	call   345 <exit>
  5d:	66 90                	xchg   %ax,%ax
  5f:	90                   	nop
 ...
 189:	31 db                	xor    %ebx,%ebx
{
 ...
 195:	57                   	push   %edi
 196:	6a 00                	push   $0x0
 198:	e8 c0 01 00 00       	call   35d <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1fd:	e8 83 01 00 00       	call   385 <open>
  if(fd < 0)
 ...
 211:	50                   	push   %eax
 212:	e8 86 01 00 00       	call   39d <fstat>
  close(fd);
 217:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 21a:	89 c6                	mov    %eax,%esi
  close(fd);
 21c:	e8 4c 01 00 00       	call   36d <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 2bb:	e8 20 04 00 00       	call   6e0 <malloc>
  void * stack;

  //setting up pagealignment
  if (((uint)stackspace % PGSIZE) == 0){
 2c0:	83 c4 10             	add    $0x10,%esp
 2c3:	a9 ff 0f 00 00       	test   $0xfff,%eax
 2c8:	74 05                	je     2cf <thread_create+0x1f>
    stack = stackspace;
  }else{
    stack = stackspace + (PGSIZE - ((uint)stackspace - PGSIZE));
 2ca:	b8 00 20 00 00       	mov    $0x2000,%eax
  }

  //call clone
  int toret = clone(start_routine, arg1, arg2, stack);
 2cf:	50                   	push   %eax
 2d0:	ff 75 10             	push   0x10(%ebp)
 2d3:	ff 75 0c             	push   0xc(%ebp)
 2d6:	ff 75 08             	push   0x8(%ebp)
 2d9:	e8 07 01 00 00       	call   3e5 <clone>
  if (toret != -1){
    return toret;
  }else {
    return -1;
 ...
 40c:	89 d1                	mov    %edx,%ecx
{
 ...
 47e:	56                   	push   %esi
 47f:	57                   	push   %edi
 480:	e8 e0 fe ff ff       	call   365 <write>
  while(--i >= 0)
 ...
 4b9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4f5:	57                   	push   %edi
 4f6:	56                   	push   %esi
 4f7:	e8 69 fe ff ff       	call   365 <write>
 ...
 529:	ff 24 85 f4 07 00 00 	jmp    *0x7f4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 54e:	e8 12 fe ff ff       	call   365 <write>
        putc(fd, c);
 ...
 55f:	57                   	push   %edi
 560:	56                   	push   %esi
 561:	e8 ff fd ff ff       	call   365 <write>
        putc(fd, c);
 ...
 60c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 60f:	e8 51 fd ff ff       	call   365 <write>
        ap++;
 ...
 637:	90                   	nop
          s = "(null)";
 638:	ba ec 07 00 00       	mov    $0x7ec,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 651:	a1 a4 0b 00 00       	mov    0xba4,%eax
{
 ...
 691:	5b                   	pop    %ebx
  freep = p;
 692:	89 15 a4 0b 00 00    	mov    %edx,0xba4
}
 698:	5e                   	pop    %esi
 699:	5f                   	pop    %edi
 69a:	5d                   	pop    %ebp
 ...
 6c9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6cc:	89 15 a4 0b 00 00    	mov    %edx,0xba4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ec:	8b 3d a4 0b 00 00    	mov    0xba4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 72f:	73 4f                	jae    780 <malloc+0xa0>
    ...
    if(p == freep)
 731:	8b 3d a4 0b 00 00    	mov    0xba4,%edi
 ...
 743:	e8 85 fc ff ff       	call   3cd <sbrk>
  if(p == (char*)-1)
 ...
 75a:	e8 f1 fe ff ff       	call   650 <free>
  return freep;
 75f:	8b 15 a4 0b 00 00    	mov    0xba4,%edx
 ...
 78c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 78f:	89 15 a4 0b 00 00    	mov    %edx,0xba4
}
 ...
 79f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7a0:	c7 05 a4 0b 00 00 a8 	movl   $0xba8,0xba4
 7a7:	0b 00 00 
    base.s.size = 0;
 7aa:	bf a8 0b 00 00       	mov    $0xba8,%edi
    base.s.ptr = freep = prevp = &base;
 7af:	c7 05 a8 0b 00 00 a8 	movl   $0xba8,0xba8
 7b6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7b9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7bb:	c7 05 ac 0b 00 00 00 	movl   $0x0,0xbac
 7c2:	00 00 00 
    if(p->s.size >= nunits){
