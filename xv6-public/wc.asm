...
main(int argc, char *argv[])
{
  ...
  33:	6a 00                	push   $0x0
  35:	ff 33                	push   (%ebx)
  37:	e8 69 04 00 00       	call   4a5 <open>
  ...
  59:	e8 2f 04 00 00       	call   48d <close>
  for(i = 1; i < argc; i++){
  ...
  exit();
  66:	e8 fa 03 00 00       	call   465 <exit>
      printf(1, "wc: cannot open %s\n", argv[i]);
  6b:	50                   	push   %eax
  6c:	ff 33                	push   (%ebx)
  ...
  75:	e8 56 05 00 00       	call   5d0 <printf>
      exit();
  7a:	e8 e6 03 00 00       	call   465 <exit>
    wc(0, "");
  7f:	52                   	push   %edx
  80:	52                   	push   %edx
  ...
  88:	e8 13 00 00 00       	call   a0 <wc>
    exit();
  8d:	e8 d3 03 00 00       	call   465 <exit>
  92:	66 90                	xchg   %ax,%ax
  94:	66 90                	xchg   %ax,%ax
  96:	66 90                	xchg   %ax,%ax
  98:	66 90                	xchg   %ax,%ax
  ...
  a6:	31 db                	xor    %ebx,%ebx
{
  ...
  d0:	e8 a8 03 00 00       	call   47d <read>
 ...
 16f:	e8 5c 04 00 00       	call   5d0 <printf>
    exit();
 174:	e8 ec 02 00 00       	call   465 <exit>
 ...
 5d9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 649:	ff 24 85 38 09 00 00 	jmp    *0x938(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 757:	90                   	nop
          s = "(null)";
 758:	ba 2f 09 00 00       	mov    $0x92f,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 771:	a1 20 0f 00 00       	mov    0xf20,%eax
{
 ...
 7b1:	5b                   	pop    %ebx
  freep = p;
 7b2:	89 15 20 0f 00 00    	mov    %edx,0xf20
}
 7b8:	5e                   	pop    %esi
 7b9:	5f                   	pop    %edi
 7ba:	5d                   	pop    %ebp
 ...
 7e9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 7ec:	89 15 20 0f 00 00    	mov    %edx,0xf20
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 809:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 80c:	8b 3d 20 0f 00 00    	mov    0xf20,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 84f:	73 4f                	jae    8a0 <malloc+0xa0>
    ...
    if(p == freep)
 851:	8b 3d 20 0f 00 00    	mov    0xf20,%edi
 ...
 87a:	e8 f1 fe ff ff       	call   770 <free>
  return freep;
 87f:	8b 15 20 0f 00 00    	mov    0xf20,%edx
 ...
 8ac:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 8af:	89 15 20 0f 00 00    	mov    %edx,0xf20
}
 ...
 8bf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 8c0:	c7 05 20 0f 00 00 24 	movl   $0xf24,0xf20
 8c7:	0f 00 00 
    base.s.size = 0;
 8ca:	bf 24 0f 00 00       	mov    $0xf24,%edi
    base.s.ptr = freep = prevp = &base;
 8cf:	c7 05 24 0f 00 00 24 	movl   $0xf24,0xf24
 8d6:	0f 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8d9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 8db:	c7 05 28 0f 00 00 00 	movl   $0x0,0xf28
 8e2:	00 00 00 
    if(p->s.size >= nunits){
