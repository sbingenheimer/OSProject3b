...
main(int argc, char *argv[])
{
  ...
  33:	6a 00                	push   $0x0
  35:	ff 33                	push   (%ebx)
  37:	e8 89 04 00 00       	call   4c5 <open>
  ...
  59:	e8 4f 04 00 00       	call   4ad <close>
  for(i = 1; i < argc; i++){
  ...
  exit();
  66:	e8 1a 04 00 00       	call   485 <exit>
      printf(1, "wc: cannot open %s\n", argv[i]);
  6b:	50                   	push   %eax
  6c:	ff 33                	push   (%ebx)
  ...
  75:	e8 76 05 00 00       	call   5f0 <printf>
      exit();
  7a:	e8 06 04 00 00       	call   485 <exit>
    wc(0, "");
  7f:	52                   	push   %edx
  80:	52                   	push   %edx
  ...
  88:	e8 13 00 00 00       	call   a0 <wc>
    exit();
  8d:	e8 f3 03 00 00       	call   485 <exit>
  92:	66 90                	xchg   %ax,%ax
  94:	66 90                	xchg   %ax,%ax
  96:	66 90                	xchg   %ax,%ax
  98:	66 90                	xchg   %ax,%ax
  ...
  a6:	31 db                	xor    %ebx,%ebx
{
  ...
  d0:	e8 c8 03 00 00       	call   49d <read>
 ...
 16f:	e8 7c 04 00 00       	call   5f0 <printf>
    exit();
 174:	e8 0c 03 00 00       	call   485 <exit>
