...
80100505:	e8 06 5b 00 00       	call   80106010 <uartputc>
8010050a:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100511:	e8 fa 5a 00 00       	call   80106010 <uartputc>
80100516:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010051d:	e8 ee 5a 00 00       	call   80106010 <uartputc>
...
80100cf8:	e8 13 67 00 00       	call   80107410 <copyout>
...
80100d5d:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100d63:	e8 a8 66 00 00       	call   80107410 <copyout>
...
80103022:	e8 19 2c 00 00       	call   80105c40 <idtinit>
...
80103081:	e8 9a 41 00 00       	call   80107220 <kvmalloc>
...
801030a4:	e8 87 2e 00 00       	call   80105f30 <uartinit>
  pinit();         // process table
801030a9:	e8 32 08 00 00       	call   801038e0 <pinit>
  tvinit();        // trap vectors
801030ae:	e8 0d 2b 00 00       	call   80105bc0 <tvinit>
  binit();         // buffer cache
...
801037ff:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103805:	e8 c6 0f 00 00       	call   801047d0 <release>
...
80103827:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010382a:	c7 40 14 af 5b 10 80 	movl   $0x80105baf,0x14(%eax)
  p->context = (struct context*)sp;
...
80103839:	e8 b2 10 00 00       	call   801048f0 <memset>
...
8010389b:	e8 30 0f 00 00       	call   801047d0 <release>
...
801038f0:	e8 6b 0d 00 00       	call   80104660 <initlock>
}
...
80103984:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103987:	e8 54 0d 00 00       	call   801046e0 <pushcli>
  c = mycpu();
8010398c:	e8 6f ff ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103991:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103997:	e8 94 0d 00 00       	call   80104730 <popcli>
}
...
801039c3:	e8 d8 37 00 00       	call   801071a0 <setupkvm>
...
801039e1:	e8 6a 34 00 00       	call   80106e50 <inituvm>
...
801039f6:	e8 f5 0e 00 00       	call   801048f0 <memset>
...
80103a55:	e8 56 10 00 00       	call   80104ab0 <safestrcpy>
  p->cwd = namei("/");
...
80103aa5:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103aa8:	e8 33 0c 00 00       	call   801046e0 <pushcli>
  c = mycpu();
80103aad:	e8 4e fe ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103ab2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ab8:	e8 73 0c 00 00       	call   80104730 <popcli>
  sz = curproc->sz;
80103abd:	8b 03                	mov    (%ebx),%eax
  if(n > 0){
80103abf:	85 f6                	test   %esi,%esi
80103ac1:	7f 32                	jg     80103af5 <growproc+0x55>
  } else if(n < 0){
80103ac3:	75 53                	jne    80103b18 <growproc+0x78>
  curproc->sz = sz;
80103ac5:	89 03                	mov    %eax,(%ebx)
  for(threads = ptable.proc; threads < &ptable.proc[NPROC]; threads++){
80103ac7:	ba 54 1d 11 80       	mov    $0x80111d54,%edx
80103acc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        threads->sz = sz;
80103ad0:	89 02                	mov    %eax,(%edx)
  for(threads = ptable.proc; threads < &ptable.proc[NPROC]; threads++){
80103ad2:	81 c2 84 00 00 00    	add    $0x84,%edx
80103ad8:	81 fa 54 3e 11 80    	cmp    $0x80113e54,%edx
80103ade:	75 f0                	jne    80103ad0 <growproc+0x30>
  switchuvm(curproc);
80103ae0:	83 ec 0c             	sub    $0xc,%esp
80103ae3:	53                   	push   %ebx
80103ae4:	e8 57 32 00 00       	call   80106d40 <switchuvm>
  return 0;
...
80103af5:	83 ec 04             	sub    $0x4,%esp
80103af8:	01 c6                	add    %eax,%esi
80103afa:	56                   	push   %esi
80103afb:	50                   	push   %eax
80103afc:	ff 73 04             	push   0x4(%ebx)
80103aff:	e8 bc 34 00 00       	call   80106fc0 <allocuvm>
80103b04:	83 c4 10             	add    $0x10,%esp
80103b07:	85 c0                	test   %eax,%eax
80103b09:	75 ba                	jne    80103ac5 <growproc+0x25>
      return -1;
80103b0b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103b10:	eb dc                	jmp    80103aee <growproc+0x4e>
...
80103b1f:	ff 73 04             	push   0x4(%ebx)
80103b22:	e8 c9 35 00 00       	call   801070f0 <deallocuvm>
80103b27:	83 c4 10             	add    $0x10,%esp
80103b2a:	85 c0                	test   %eax,%eax
80103b2c:	75 97                	jne    80103ac5 <growproc+0x25>
80103b2e:	eb db                	jmp    80103b0b <growproc+0x6b>
...
80103b36:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b39:	e8 a2 0b 00 00       	call   801046e0 <pushcli>
  c = mycpu();
80103b3e:	e8 bd fd ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103b43:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b49:	e8 e2 0b 00 00       	call   80104730 <popcli>
  if((np = allocproc()) == 0){
...
80103b68:	e8 23 37 00 00       	call   80107290 <copyuvm>
...
80103c7e:	e8 ad 0b 00 00       	call   80104830 <acquire>
...
80103ca0:	e8 9b 30 00 00       	call   80106d40 <switchuvm>
...
80103cab:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103cb2:	e8 54 0e 00 00       	call   80104b0b <swtch>
      switchkvm();
80103cb7:	e8 74 30 00 00       	call   80106d30 <switchkvm>
      c->proc = 0;
80103cbc:	83 c4 10             	add    $0x10,%esp
80103cbf:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
80103cc6:	00 00 00 
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cc9:	81 c3 84 00 00 00    	add    $0x84,%ebx
80103ccf:	81 fb 54 3e 11 80    	cmp    $0x80113e54,%ebx
80103cd5:	75 b9                	jne    80103c90 <scheduler+0x40>
    release(&ptable.lock);
80103cd7:	83 ec 0c             	sub    $0xc,%esp
80103cda:	68 20 1d 11 80       	push   $0x80111d20
80103cdf:	e8 ec 0a 00 00       	call   801047d0 <release>
    sti();
...
80103d53:	e8 b3 0d 00 00       	call   80104b0b <swtch>
  mycpu()->intena = intena;
...
80103db9:	e8 c2 fb ff ff       	call   80103980 <myproc>
  if(curproc == initproc)
80103dbe:	39 05 54 3e 11 80    	cmp    %eax,0x80113e54
...
80103e1a:	e8 11 0a 00 00       	call   80104830 <acquire>
...
80103ec7:	68 c8 7a 10 80       	push   $0x80107ac8
80103ecc:	e8 af c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103ed1:	83 ec 0c             	sub    $0xc,%esp
80103ed4:	68 bb 7a 10 80       	push   $0x80107abb
...
80103f02:	e8 29 09 00 00       	call   80104830 <acquire>
...
80103f24:	74 7a                	je     80103fa0 <wait+0xc0>
      if(p->parent != curproc || p->pgdir == p->parent->pgdir)
80103f26:	39 73 14             	cmp    %esi,0x14(%ebx)
80103f29:	75 ed                	jne    80103f18 <wait+0x38>
80103f2b:	8b 56 04             	mov    0x4(%esi),%edx
80103f2e:	39 53 04             	cmp    %edx,0x4(%ebx)
80103f31:	74 e5                	je     80103f18 <wait+0x38>
      if(p->state == ZOMBIE && p->hasThreads != 1){
80103f33:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
      havekids = 1;
80103f37:	b8 01 00 00 00       	mov    $0x1,%eax
      if(p->state == ZOMBIE && p->hasThreads != 1){
80103f3c:	75 da                	jne    80103f18 <wait+0x38>
80103f3e:	8b 83 80 00 00 00    	mov    0x80(%ebx),%eax
80103f44:	83 f8 01             	cmp    $0x1,%eax
80103f47:	74 cf                	je     80103f18 <wait+0x38>
        kfree(p->kstack);
80103f49:	83 ec 0c             	sub    $0xc,%esp
        pid = p->pid;
80103f4c:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
80103f4f:	ff 73 08             	push   0x8(%ebx)
80103f52:	e8 69 e5 ff ff       	call   801024c0 <kfree>
        p->kstack = 0;
80103f57:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103f5e:	5a                   	pop    %edx
80103f5f:	ff 73 04             	push   0x4(%ebx)
80103f62:	e8 b9 31 00 00       	call   80107120 <freevm>
        p->pid = 0;
80103f67:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
80103f6e:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
80103f75:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        p->killed = 0;
80103f79:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
80103f80:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103f87:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103f8e:	e8 3d 08 00 00       	call   801047d0 <release>
        return pid;
...
80103fa2:	74 3b                	je     80103fdf <wait+0xff>
80103fa4:	8b 46 24             	mov    0x24(%esi),%eax
80103fa7:	85 c0                	test   %eax,%eax
80103fa9:	75 34                	jne    80103fdf <wait+0xff>
  pushcli();
80103fab:	e8 30 07 00 00       	call   801046e0 <pushcli>
  c = mycpu();
80103fb0:	e8 4b f9 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103fb5:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103fbb:	e8 70 07 00 00       	call   80104730 <popcli>
  if(p == 0)
80103fc0:	85 db                	test   %ebx,%ebx
80103fc2:	74 39                	je     80103ffd <wait+0x11d>
  p->chan = chan;
80103fc4:	89 73 20             	mov    %esi,0x20(%ebx)
  p->state = SLEEPING;
80103fc7:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80103fce:	e8 1d fd ff ff       	call   80103cf0 <sched>
  p->chan = 0;
80103fd3:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
}
80103fda:	e9 2b ff ff ff       	jmp    80103f0a <wait+0x2a>
      release(&ptable.lock);
80103fdf:	83 ec 0c             	sub    $0xc,%esp
      return -1;
80103fe2:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80103fe7:	68 20 1d 11 80       	push   $0x80111d20
80103fec:	e8 df 07 00 00       	call   801047d0 <release>
      return -1;
...
80104000:	68 d4 7a 10 80       	push   $0x80107ad4
...
8010401c:	e8 0f 08 00 00       	call   80104830 <acquire>
  pushcli();
80104021:	e8 ba 06 00 00       	call   801046e0 <pushcli>
  c = mycpu();
80104026:	e8 d5 f8 ff ff       	call   80103900 <mycpu>
  p = c->proc;
8010402b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104031:	e8 fa 06 00 00       	call   80104730 <popcli>
...
80104049:	e8 82 07 00 00       	call   801047d0 <release>
}
...
8010406c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
8010406f:	e8 6c 06 00 00       	call   801046e0 <pushcli>
  c = mycpu();
80104074:	e8 87 f8 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80104079:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010407f:	e8 ac 06 00 00       	call   80104730 <popcli>
  if(p == 0)
...
801040a0:	e8 8b 07 00 00       	call   80104830 <acquire>
    release(lk);
801040a5:	89 34 24             	mov    %esi,(%esp)
801040a8:	e8 23 07 00 00       	call   801047d0 <release>
  p->chan = chan;
...
801040ca:	e8 01 07 00 00       	call   801047d0 <release>
    acquire(lk);
...
801040db:	5d                   	pop    %ebp
    acquire(lk);
801040dc:	e9 4f 07 00 00       	jmp    80104830 <acquire>
...
80104109:	68 da 7a 10 80       	push   $0x80107ada
8010410e:	e8 6d c2 ff ff       	call   80100380 <panic>
    panic("sleep");
80104113:	83 ec 0c             	sub    $0xc,%esp
80104116:	68 d4 7a 10 80       	push   $0x80107ad4
...
8010412f:	e8 fc 06 00 00       	call   80104830 <acquire>
...
80104174:	c9                   	leave  
  release(&ptable.lock);
80104175:	e9 56 06 00 00       	jmp    801047d0 <release>
...
8010418f:	e8 9c 06 00 00       	call   80104830 <acquire>
...
801041cd:	e8 fe 05 00 00       	call   801047d0 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
801041e8:	e8 e3 05 00 00       	call   801047d0 <release>
}
...
8010421b:	68 5f 7e 10 80       	push   $0x80107e5f
...
8010423f:	74 e7                	je     80104228 <procdump+0x28>
      state = "???";
80104241:	ba eb 7a 10 80       	mov    $0x80107aeb,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104246:	83 f8 05             	cmp    $0x5,%eax
80104249:	77 11                	ja     8010425c <procdump+0x5c>
8010424b:	8b 14 85 4c 7b 10 80 	mov    -0x7fef84b4(,%eax,4),%edx
      state = "???";
80104252:	b8 eb 7a 10 80       	mov    $0x80107aeb,%eax
...
80104261:	68 ef 7a 10 80       	push   $0x80107aef
...
80104288:	e8 f3 03 00 00       	call   80104680 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
8010429d:	68 41 75 10 80       	push   $0x80107541
...
801042c6:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
801042c9:	e8 12 04 00 00       	call   801046e0 <pushcli>
  c = mycpu();
801042ce:	e8 2d f6 ff ff       	call   80103900 <mycpu>
  p = c->proc;
801042d3:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
801042d9:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  popcli();
801042dc:	e8 4f 04 00 00       	call   80104730 <popcli>
  int i, pid;
  struct proc *np;
  struct proc *curproc = myproc();
  ...
  // Allocate process.
  if((np = allocproc()) == 0){
801042e1:	e8 ca f4 ff ff       	call   801037b0 <allocproc>
801042e6:	85 c0                	test   %eax,%eax
801042e8:	0f 84 f7 00 00 00    	je     801043e5 <clone+0x125>
    return -1;
  }
...
801042f1:	89 c3                	mov    %eax,%ebx
  np->parent = curproc;
  *np->tf = *curproc->tf;
801042f3:	b9 13 00 00 00       	mov    $0x13,%ecx
801042f8:	8b 7b 18             	mov    0x18(%ebx),%edi
  np->sz = curproc->sz;
801042fb:	8b 02                	mov    (%edx),%eax
  np->parent = curproc;
801042fd:	89 53 14             	mov    %edx,0x14(%ebx)
  np->sz = curproc->sz;
80104300:	89 03                	mov    %eax,(%ebx)
  *np->tf = *curproc->tf;
80104302:	8b 72 18             	mov    0x18(%edx),%esi
80104305:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  void * insret;
...
80104307:	8b 4d 14             	mov    0x14(%ebp),%ecx
...
//rest from fork
for(i = 0; i < NOFILE; i++)
8010430a:	31 f6                	xor    %esi,%esi
8010430c:	89 d7                	mov    %edx,%edi
  np->pgdir = curproc->pgdir;
8010430e:	8b 42 04             	mov    0x4(%edx),%eax
  np->hasThreads = 1;
80104311:	c7 83 80 00 00 00 01 	movl   $0x1,0x80(%ebx)
80104318:	00 00 00 
  np->pgdir = curproc->pgdir;
8010431b:	89 43 04             	mov    %eax,0x4(%ebx)
  np->tstack = stack; //saving threads user stack
8010431e:	8b 45 14             	mov    0x14(%ebp),%eax
80104321:	89 43 7c             	mov    %eax,0x7c(%ebx)
  * (uint*) insret = 0xffffffff;
80104324:	c7 80 f4 0f 00 00 ff 	movl   $0xffffffff,0xff4(%eax)
8010432b:	ff ff ff 
  * (uint*) insarg1 = (uint) arg1;
8010432e:	8b 45 0c             	mov    0xc(%ebp),%eax
80104331:	89 81 f8 0f 00 00    	mov    %eax,0xff8(%ecx)
  * (uint*) insarg2 = (uint) arg2;
80104337:	8b 45 10             	mov    0x10(%ebp),%eax
8010433a:	89 81 fc 0f 00 00    	mov    %eax,0xffc(%ecx)
np->tf->esp = (uint)stack; //initialize esp to thread stack
80104340:	8b 43 18             	mov    0x18(%ebx),%eax
80104343:	89 48 44             	mov    %ecx,0x44(%eax)
np->tf->esp += PGSIZE - 3 * sizeof(void*); //setting esp to top of stack
80104346:	8b 43 18             	mov    0x18(%ebx),%eax
80104349:	81 40 44 f4 0f 00 00 	addl   $0xff4,0x44(%eax)
np->tf->ebp = np->tf->esp; //setting base reg = to esp
80104350:	8b 43 18             	mov    0x18(%ebx),%eax
80104353:	8b 48 44             	mov    0x44(%eax),%ecx
80104356:	89 48 08             	mov    %ecx,0x8(%eax)
np->tf->eip = (uint) fcn; //setting inst reg to the fnc
80104359:	8b 4d 08             	mov    0x8(%ebp),%ecx
8010435c:	8b 43 18             	mov    0x18(%ebx),%eax
8010435f:	89 48 38             	mov    %ecx,0x38(%eax)
np->tf->eax = 0; //setting ret reg to 0 so child will return 0
80104362:	8b 43 18             	mov    0x18(%ebx),%eax
80104365:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
for(i = 0; i < NOFILE; i++)
8010436c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(curproc->ofile[i])
80104370:	8b 44 b7 28          	mov    0x28(%edi,%esi,4),%eax
80104374:	85 c0                	test   %eax,%eax
80104376:	74 10                	je     80104388 <clone+0xc8>
      np->ofile[i] = filedup(curproc->ofile[i]);
80104378:	83 ec 0c             	sub    $0xc,%esp
8010437b:	50                   	push   %eax
8010437c:	e8 1f cb ff ff       	call   80100ea0 <filedup>
80104381:	83 c4 10             	add    $0x10,%esp
80104384:	89 44 b3 28          	mov    %eax,0x28(%ebx,%esi,4)
for(i = 0; i < NOFILE; i++)
80104388:	83 c6 01             	add    $0x1,%esi
8010438b:	83 fe 10             	cmp    $0x10,%esi
8010438e:	75 e0                	jne    80104370 <clone+0xb0>
  np->cwd = idup(curproc->cwd);
80104390:	83 ec 0c             	sub    $0xc,%esp
80104393:	ff 77 68             	push   0x68(%edi)
80104396:	89 7d e4             	mov    %edi,-0x1c(%ebp)
80104399:	e8 b2 d3 ff ff       	call   80101750 <idup>

  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
8010439e:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801043a1:	83 c4 0c             	add    $0xc,%esp
  np->cwd = idup(curproc->cwd);
801043a4:	89 43 68             	mov    %eax,0x68(%ebx)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
801043a7:	8d 43 6c             	lea    0x6c(%ebx),%eax
801043aa:	83 c2 6c             	add    $0x6c,%edx
801043ad:	6a 10                	push   $0x10
801043af:	52                   	push   %edx
801043b0:	50                   	push   %eax
801043b1:	e8 fa 06 00 00       	call   80104ab0 <safestrcpy>

  pid = np->pid;
801043b6:	8b 73 10             	mov    0x10(%ebx),%esi

  acquire(&ptable.lock);
801043b9:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
801043c0:	e8 6b 04 00 00       	call   80104830 <acquire>

  np->state = RUNNABLE;
801043c5:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)

  release(&ptable.lock);
801043cc:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
801043d3:	e8 f8 03 00 00       	call   801047d0 <release>
...
801043db:	8d 65 f4             	lea    -0xc(%ebp),%esp
801043de:	89 f0                	mov    %esi,%eax
801043e0:	5b                   	pop    %ebx
801043e1:	5e                   	pop    %esi
801043e2:	5f                   	pop    %edi
801043e3:	5d                   	pop    %ebp
801043e4:	c3                   	ret    
    return -1;
801043e5:	be ff ff ff ff       	mov    $0xffffffff,%esi
801043ea:	eb ef                	jmp    801043db <clone+0x11b>
...
801043f4:	53                   	push   %ebx
  pushcli();
801043f5:	e8 e6 02 00 00       	call   801046e0 <pushcli>
  c = mycpu();
801043fa:	e8 01 f5 ff ff       	call   80103900 <mycpu>
  p = c->proc;
801043ff:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80104405:	e8 26 03 00 00       	call   80104730 <popcli>
  struct proc *p;
  int havekids, pid;
  struct proc *curproc = myproc();
...
8010440d:	68 20 1d 11 80       	push   $0x80111d20
80104412:	e8 19 04 00 00       	call   80104830 <acquire>
...
8010441a:	31 c0                	xor    %eax,%eax
    ...
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010441c:	bb 54 1d 11 80       	mov    $0x80111d54,%ebx
80104421:	eb 17                	jmp    8010443a <join+0x4a>
80104423:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104427:	90                   	nop
80104428:	81 c3 84 00 00 00    	add    $0x84,%ebx
8010442e:	81 fb 54 3e 11 80    	cmp    $0x80113e54,%ebx
80104434:	0f 84 86 00 00 00    	je     801044c0 <join+0xd0>
      if(p->parent != curproc || p->pgdir != p->parent->pgdir)
8010443a:	39 73 14             	cmp    %esi,0x14(%ebx)
8010443d:	75 e9                	jne    80104428 <join+0x38>
8010443f:	8b 4e 04             	mov    0x4(%esi),%ecx
80104442:	39 4b 04             	cmp    %ecx,0x4(%ebx)
80104445:	75 e1                	jne    80104428 <join+0x38>
        continue;

      havekids = 1;
      if(p->state == ZOMBIE && p->hasThreads == 1){
80104447:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
      havekids = 1;
8010444b:	b8 01 00 00 00       	mov    $0x1,%eax
      if(p->state == ZOMBIE && p->hasThreads == 1){
80104450:	75 d6                	jne    80104428 <join+0x38>
80104452:	83 bb 80 00 00 00 01 	cmpl   $0x1,0x80(%ebx)
80104459:	75 cd                	jne    80104428 <join+0x38>
        // Found one.
        *stack = p->tstack; //getting user stack into stack
8010445b:	8b 53 7c             	mov    0x7c(%ebx),%edx
8010445e:	8b 45 08             	mov    0x8(%ebp),%eax
        pid = p->pid;
        kfree(p->kstack);
80104461:	83 ec 0c             	sub    $0xc,%esp
        *stack = p->tstack; //getting user stack into stack
80104464:	89 10                	mov    %edx,(%eax)
        pid = p->pid;
80104466:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
80104469:	ff 73 08             	push   0x8(%ebx)
8010446c:	e8 4f e0 ff ff       	call   801024c0 <kfree>
        p->kstack = 0;
80104471:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        p->tstack = 0;  //freeing 
80104478:	c7 43 7c 00 00 00 00 	movl   $0x0,0x7c(%ebx)
        p->pid = 0;
8010447f:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
80104486:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
8010448d:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        p->killed = 0;
80104491:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
80104498:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
8010449f:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
801044a6:	e8 25 03 00 00       	call   801047d0 <release>
        return pid;
...
801044c2:	74 3b                	je     801044ff <join+0x10f>
801044c4:	8b 46 24             	mov    0x24(%esi),%eax
801044c7:	85 c0                	test   %eax,%eax
801044c9:	75 34                	jne    801044ff <join+0x10f>
  pushcli();
801044cb:	e8 10 02 00 00       	call   801046e0 <pushcli>
  c = mycpu();
801044d0:	e8 2b f4 ff ff       	call   80103900 <mycpu>
  p = c->proc;
801044d5:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801044db:	e8 50 02 00 00       	call   80104730 <popcli>
  if(p == 0)
801044e0:	85 db                	test   %ebx,%ebx
801044e2:	74 39                	je     8010451d <join+0x12d>
  p->chan = chan;
801044e4:	89 73 20             	mov    %esi,0x20(%ebx)
  p->state = SLEEPING;
801044e7:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
801044ee:	e8 fd f7 ff ff       	call   80103cf0 <sched>
  p->chan = 0;
801044f3:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
}
801044fa:	e9 1b ff ff ff       	jmp    8010441a <join+0x2a>
      release(&ptable.lock);
801044ff:	83 ec 0c             	sub    $0xc,%esp
      return -1;
80104502:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80104507:	68 20 1d 11 80       	push   $0x80111d20
8010450c:	e8 bf 02 00 00       	call   801047d0 <release>
      return -1;
80104511:	83 c4 10             	add    $0x10,%esp
}
80104514:	8d 65 f8             	lea    -0x8(%ebp),%esp
...
80104520:	68 d4 7a 10 80       	push   $0x80107ad4
80104525:	e8 56 be ff ff       	call   80100380 <panic>
...
8010453a:	68 64 7b 10 80       	push   $0x80107b64
...
80104595:	e8 c6 fa ff ff       	call   80104060 <sleep>
  while (lk->locked) {
...
801045a3:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
801045a9:	e8 d2 f3 ff ff       	call   80103980 <myproc>
...
801045f4:	e8 27 fb ff ff       	call   80104120 <wakeup>
  release(&lk->lk);
...
8010464b:	e8 30 f3 ff ff       	call   80103980 <myproc>
...
8010470a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    mycpu()->intena = eflags & FL_IF;
80104710:	e8 eb f1 ff ff       	call   80103900 <mycpu>
...
8010473b:	75 35                	jne    80104772 <popcli+0x42>
  ...
  if(--mycpu()->ncli < 0)
8010473d:	e8 be f1 ff ff       	call   80103900 <mycpu>
...
8010475c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104760:	e8 9b f1 ff ff       	call   80103900 <mycpu>
...
80104775:	68 6f 7b 10 80       	push   $0x80107b6f
8010477a:	e8 01 bc ff ff       	call   80100380 <panic>
    panic("popcli");
8010477f:	83 ec 0c             	sub    $0xc,%esp
80104782:	68 86 7b 10 80       	push   $0x80107b86
...
801047b3:	e8 48 f1 ff ff       	call   80103900 <mycpu>
...
8010486c:	e8 8f f0 ff ff       	call   80103900 <mycpu>
...
801048cb:	e8 30 f0 ff ff       	call   80103900 <mycpu>
...
801048e0:	68 95 7b 10 80       	push   $0x80107b95
...
80104b27:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80104b2a:	e8 51 ee ff ff       	call   80103980 <myproc>
...
80104bb5:	e8 c6 ed ff ff       	call   80103980 <myproc>
...
80104bc3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104bc6:	e8 b5 ed ff ff       	call   80103980 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104c06:	83 ec 0c             	sub    $0xc,%esp
  int i;
  struct proc *curproc = myproc();
80104c09:	e8 72 ed ff ff       	call   80103980 <myproc>
80104c0e:	89 c6                	mov    %eax,%esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104c10:	e8 6b ed ff ff       	call   80103980 <myproc>
...
80104c1e:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104c21:	e8 5a ed ff ff       	call   80103980 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104c9b:	8b 5b 04             	mov    0x4(%ebx),%ebx
  struct proc *curproc = myproc();
80104c9e:	e8 dd ec ff ff       	call   80103980 <myproc>
  if(addr >= curproc->sz)
...
80104cf4:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104cf7:	e8 84 ec ff ff       	call   80103980 <myproc>
...
80104d0c:	8b 14 85 c0 7b 10 80 	mov    -0x7fef8440(,%eax,4),%edx
...
80104d38:	68 9d 7b 10 80       	push   $0x80107b9d
...
80104e94:	68 3c 7c 10 80       	push   $0x80107c3c
...
80104eac:	68 3b 7c 10 80       	push   $0x80107c3b
...
80104ec1:	68 2f 7c 10 80       	push   $0x80107c2f
...
80104edf:	68 3e 7c 10 80       	push   $0x80107c3e
80104ee4:	e8 97 b4 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104ee9:	83 ec 0c             	sub    $0xc,%esp
80104eec:	68 20 7c 10 80       	push   $0x80107c20
...
801050b1:	74 25                	je     801050d8 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
801050b3:	e8 c8 e8 ff ff       	call   80103980 <myproc>
  fileclose(f);
...
801052ed:	58                   	pop    %eax
801052ee:	5a                   	pop    %edx
801052ef:	68 3c 7c 10 80       	push   $0x80107c3c
...
80105308:	68 3b 7c 10 80       	push   $0x80107c3b
...
801054f7:	74 23                	je     8010551c <sys_open+0x9c>
  struct proc *curproc = myproc();
801054f9:	e8 82 e4 ff ff       	call   80103980 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105887:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105889:	e8 f2 e0 ff ff       	call   80103980 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801058e6:	75 f0                	jne    801058d8 <sys_pipe+0x88>
      myproc()->ofile[fd0] = 0;
801058e8:	e8 93 e0 ff ff       	call   80103980 <myproc>
...
{
  return fork();
80105920:	e9 0b e2 ff ff       	jmp    80103b30 <fork>
...
80105933:	83 ec 08             	sub    $0x8,%esp
  exit();
80105936:	e8 75 e4 ff ff       	call   80103db0 <exit>
...
{
  return wait();
80105940:	e9 9b e5 ff ff       	jmp    80103ee0 <wait>
...
8010596e:	e8 0d e8 ff ff       	call   80104180 <kill>
...
80105993:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105996:	e8 e5 df ff ff       	call   80103980 <myproc>
...
801059c6:	e8 d5 e0 ff ff       	call   80103aa0 <growproc>
...
80105a10:	68 80 3e 11 80       	push   $0x80113e80
80105a15:	e8 16 ee ff ff       	call   80104830 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105a1a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105a1d:	8b 1d 60 3e 11 80    	mov    0x80113e60,%ebx
  while(ticks - ticks0 < n){
...
80105a33:	68 80 3e 11 80       	push   $0x80113e80
80105a38:	68 60 3e 11 80       	push   $0x80113e60
80105a3d:	e8 1e e6 ff ff       	call   80104060 <sleep>
  while(ticks - ticks0 < n){
80105a42:	a1 60 3e 11 80       	mov    0x80113e60,%eax
...
80105a4f:	73 2f                	jae    80105a80 <sys_sleep+0x90>
    if(myproc()->killed){
80105a51:	e8 2a df ff ff       	call   80103980 <myproc>
...
80105a60:	68 80 3e 11 80       	push   $0x80113e80
...
80105a83:	68 80 3e 11 80       	push   $0x80113e80
...
80105aa4:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105aa7:	68 80 3e 11 80       	push   $0x80113e80
80105aac:	e8 7f ed ff ff       	call   80104830 <acquire>
  xticks = ticks;
80105ab1:	8b 1d 60 3e 11 80    	mov    0x80113e60,%ebx
  release(&tickslock);
80105ab7:	c7 04 24 80 3e 11 80 	movl   $0x80113e80,(%esp)
...
80105ae8:	78 66                	js     80105b50 <sys_clone+0x80>
  return -1;
}
...
80105aff:	78 4f                	js     80105b50 <sys_clone+0x80>
  return -1;
}
...
80105b2d:	78 21                	js     80105b50 <sys_clone+0x80>
  return -1;
}

if (((uint)stack % PGSIZE) != 0){
80105b2f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b32:	a9 ff 0f 00 00       	test   $0xfff,%eax
80105b37:	75 17                	jne    80105b50 <sys_clone+0x80>
  return -1;
}

return clone((void*)fcn, (void*)arg1, (void*)arg2, (void*)stack);
80105b39:	50                   	push   %eax
80105b3a:	ff 75 f0             	push   -0x10(%ebp)
80105b3d:	ff 75 ec             	push   -0x14(%ebp)
80105b40:	ff 75 e8             	push   -0x18(%ebp)
80105b43:	e8 78 e7 ff ff       	call   801042c0 <clone>
...
80105b6e:	e8 8d f0 ff ff       	call   80104c00 <argptr>
80105b73:	83 c4 10             	add    $0x10,%esp
80105b76:	85 c0                	test   %eax,%eax
80105b78:	78 16                	js     80105b90 <sys_join+0x30>
  return -1;
}

return join(stack);
80105b7a:	83 ec 0c             	sub    $0xc,%esp
80105b7d:	ff 75 f4             	push   -0xc(%ebp)
80105b80:	e8 6b e8 ff ff       	call   801043f0 <join>
...
80105bd7:	c7 04 c5 c2 3e 11 80 	movl   $0x8e000008,-0x7feec13e(,%eax,8)
80105bde:	08 00 00 8e 
80105be2:	66 89 14 c5 c0 3e 11 	mov    %dx,-0x7feec140(,%eax,8)
80105be9:	80 
80105bea:	c1 ea 10             	shr    $0x10,%edx
80105bed:	66 89 14 c5 c6 3e 11 	mov    %dx,-0x7feec13a(,%eax,8)
80105bf4:	80 
  for(i = 0; i < 256; i++)
...
80105c07:	c7 05 c2 40 11 80 08 	movl   $0xef000008,0x801140c2
80105c0e:	00 00 ef 
  initlock(&tickslock, "time");
80105c11:	68 81 7c 10 80       	push   $0x80107c81
80105c16:	68 80 3e 11 80       	push   $0x80113e80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105c1b:	66 a3 c0 40 11 80    	mov    %ax,0x801140c0
80105c21:	c1 e8 10             	shr    $0x10,%eax
80105c24:	66 a3 c6 40 11 80    	mov    %ax,0x801140c6
  initlock(&tickslock, "time");
80105c2a:	e8 31 ea ff ff       	call   80104660 <initlock>
}
...
80105c4b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105c4f:	b8 c0 3e 11 80       	mov    $0x80113ec0,%eax
...
80105c82:	0f 84 68 01 00 00    	je     80105df0 <trap+0x180>
    if(myproc()->killed)
      exit();
    return;
  }
...
80105c8e:	0f 87 8c 00 00 00    	ja     80105d20 <trap+0xb0>
80105c94:	ff 24 85 28 7d 10 80 	jmp    *-0x7fef82d8(,%eax,4)
...
80105caa:	e8 d1 dc ff ff       	call   80103980 <myproc>
80105caf:	85 c0                	test   %eax,%eax
80105cb1:	74 1d                	je     80105cd0 <trap+0x60>
80105cb3:	e8 c8 dc ff ff       	call   80103980 <myproc>
...
80105cd9:	e8 a2 dc ff ff       	call   80103980 <myproc>
...
80105d40:	e8 1b dc ff ff       	call   80103960 <cpuid>
...
80105d51:	e8 2a dc ff ff       	call   80103980 <myproc>
80105d56:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105d59:	e8 22 dc ff ff       	call   80103980 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105d75:	68 e4 7c 10 80       	push   $0x80107ce4
80105d7a:	e8 21 a9 ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
80105d7f:	83 c4 20             	add    $0x20,%esp
80105d82:	e8 f9 db ff ff       	call   80103980 <myproc>
...
80105da4:	0f 85 3e ff ff ff    	jne    80105ce8 <trap+0x78>
    yield();
80105daa:	e8 61 e2 ff ff       	call   80104010 <yield>
...
80105dbf:	e8 9c db ff ff       	call   80103960 <cpuid>
80105dc4:	57                   	push   %edi
80105dc5:	56                   	push   %esi
80105dc6:	50                   	push   %eax
80105dc7:	68 8c 7c 10 80       	push   $0x80107c8c
80105dcc:	e8 cf a8 ff ff       	call   801006a0 <cprintf>
    lapiceoi();
80105dd1:	e8 3a cb ff ff       	call   80102910 <lapiceoi>
    break;
...
80105e05:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105e08:	e8 e3 ee ff ff       	call   80104cf0 <syscall>
    if(myproc()->killed)
80105e0d:	e8 6e db ff ff       	call   80103980 <myproc>
...
80105e23:	5d                   	pop    %ebp
      exit();
80105e24:	e9 87 df ff ff       	jmp    80103db0 <exit>
80105e29:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
80105e30:	e8 3b 02 00 00       	call   80106070 <uartintr>
    lapiceoi();
80105e35:	e8 d6 ca ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105e3a:	e8 41 db ff ff       	call   80103980 <myproc>
...
80105e4c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105e50:	e8 7b c9 ff ff       	call   801027d0 <kbdintr>
    lapiceoi();
80105e55:	e8 b6 ca ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105e5a:	e8 21 db ff ff       	call   80103980 <myproc>
...
80105e80:	68 80 3e 11 80       	push   $0x80113e80
80105e85:	e8 a6 e9 ff ff       	call   80104830 <acquire>
      wakeup(&ticks);
80105e8a:	c7 04 24 60 3e 11 80 	movl   $0x80113e60,(%esp)
      ticks++;
80105e91:	83 05 60 3e 11 80 01 	addl   $0x1,0x80113e60
      wakeup(&ticks);
80105e98:	e8 83 e2 ff ff       	call   80104120 <wakeup>
      release(&tickslock);
80105e9d:	c7 04 24 80 3e 11 80 	movl   $0x80113e80,(%esp)
80105ea4:	e8 27 e9 ff ff       	call   801047d0 <release>
...
{
  if(!uart)
80105f00:	a1 c0 46 11 80       	mov    0x801146c0,%eax
80105f05:	85 c0                	test   %eax,%eax
80105f07:	74 17                	je     80105f20 <uartgetc+0x20>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80105f09:	ba fd 03 00 00       	mov    $0x3fd,%edx
80105f0e:	ec                   	in     (%dx),%al
    return -1;
  if(!(inb(COM1+5) & 0x01))
80105f0f:	a8 01                	test   $0x1,%al
80105f11:	74 0d                	je     80105f20 <uartgetc+0x20>
80105f13:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105f18:	ec                   	in     (%dx),%al
    return -1;
  return inb(COM1+0);
80105f19:	0f b6 c0             	movzbl %al,%eax
80105f1c:	c3                   	ret    
...
80105f38:	bf fa 03 00 00       	mov    $0x3fa,%edi
80105f3d:	56                   	push   %esi
80105f3e:	89 fa                	mov    %edi,%edx
80105f40:	53                   	push   %ebx
80105f41:	83 ec 1c             	sub    $0x1c,%esp
80105f44:	ee                   	out    %al,(%dx)
80105f45:	be fb 03 00 00       	mov    $0x3fb,%esi
...
80105f5d:	bb f9 03 00 00       	mov    $0x3f9,%ebx
80105f62:	89 c8                	mov    %ecx,%eax
80105f64:	89 da                	mov    %ebx,%edx
...
80105f87:	74 78                	je     80106001 <uartinit+0xd1>
  uart = 1;
80105f89:	c7 05 c0 46 11 80 01 	movl   $0x1,0x801146c0
80105f90:	00 00 00 
...
80105f9c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105f9f:	bf a8 7d 10 80       	mov    $0x80107da8,%edi
80105fa4:	be fd 03 00 00       	mov    $0x3fd,%esi
  ioapicenable(IRQ_COM1, 0);
80105fa9:	6a 00                	push   $0x0
80105fab:	6a 04                	push   $0x4
80105fad:	e8 ce c4 ff ff       	call   80102480 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
80105fb2:	c6 45 e7 78          	movb   $0x78,-0x19(%ebp)
  ioapicenable(IRQ_COM1, 0);
80105fb6:	83 c4 10             	add    $0x10,%esp
80105fb9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
80105fc0:	a1 c0 46 11 80       	mov    0x801146c0,%eax
80105fc5:	bb 80 00 00 00       	mov    $0x80,%ebx
80105fca:	85 c0                	test   %eax,%eax
80105fcc:	75 14                	jne    80105fe2 <uartinit+0xb2>
80105fce:	eb 23                	jmp    80105ff3 <uartinit+0xc3>
    microdelay(10);
...
80105fe0:	74 07                	je     80105fe9 <uartinit+0xb9>
80105fe2:	89 f2                	mov    %esi,%edx
80105fe4:	ec                   	in     (%dx),%al
80105fe5:	a8 20                	test   $0x20,%al
80105fe7:	74 e7                	je     80105fd0 <uartinit+0xa0>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80105fe9:	0f b6 45 e7          	movzbl -0x19(%ebp),%eax
80105fed:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105ff2:	ee                   	out    %al,(%dx)
  for(p="xv6...\n"; *p; p++)
80105ff3:	0f b6 47 01          	movzbl 0x1(%edi),%eax
80105ff7:	83 c7 01             	add    $0x1,%edi
80105ffa:	88 45 e7             	mov    %al,-0x19(%ebp)
80105ffd:	84 c0                	test   %al,%al
80105fff:	75 bf                	jne    80105fc0 <uartinit+0x90>
}
...
80106010 <uartputc>:
  if(!uart)
80106010:	a1 c0 46 11 80       	mov    0x801146c0,%eax
80106015:	85 c0                	test   %eax,%eax
80106017:	74 47                	je     80106060 <uartputc+0x50>
{
...
8010607b:	e8 00 a8 ff ff       	call   80100880 <consoleintr>
}
...
80106b15:	89 4d e0             	mov    %ecx,-0x20(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80106b18:	39 d3                	cmp    %edx,%ebx
80106b1a:	73 49                	jae    80106b65 <deallocuvm.part.0+0x65>
80106b1c:	89 c7                	mov    %eax,%edi
80106b1e:	eb 0c                	jmp    80106b2c <deallocuvm.part.0+0x2c>
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
80106b20:	83 c0 01             	add    $0x1,%eax
80106b23:	c1 e0 16             	shl    $0x16,%eax
80106b26:	89 c3                	mov    %eax,%ebx
  for(; a  < oldsz; a += PGSIZE){
80106b28:	39 da                	cmp    %ebx,%edx
80106b2a:	76 39                	jbe    80106b65 <deallocuvm.part.0+0x65>
  pde = &pgdir[PDX(va)];
80106b2c:	89 d8                	mov    %ebx,%eax
80106b2e:	c1 e8 16             	shr    $0x16,%eax
  if(*pde & PTE_P){
80106b31:	8b 0c 87             	mov    (%edi,%eax,4),%ecx
80106b34:	f6 c1 01             	test   $0x1,%cl
80106b37:	74 e7                	je     80106b20 <deallocuvm.part.0+0x20>
  return &pgtab[PTX(va)];
80106b39:	89 de                	mov    %ebx,%esi
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80106b3b:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
  return &pgtab[PTX(va)];
80106b41:	c1 ee 0a             	shr    $0xa,%esi
80106b44:	81 e6 fc 0f 00 00    	and    $0xffc,%esi
80106b4a:	8d b4 31 00 00 00 80 	lea    -0x80000000(%ecx,%esi,1),%esi
    if(!pte)
80106b51:	85 f6                	test   %esi,%esi
80106b53:	74 cb                	je     80106b20 <deallocuvm.part.0+0x20>
    else if((*pte & PTE_P) != 0){
80106b55:	8b 06                	mov    (%esi),%eax
80106b57:	a8 01                	test   $0x1,%al
80106b59:	75 15                	jne    80106b70 <deallocuvm.part.0+0x70>
  for(; a  < oldsz; a += PGSIZE){
80106b5b:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106b61:	39 da                	cmp    %ebx,%edx
80106b63:	77 c7                	ja     80106b2c <deallocuvm.part.0+0x2c>
      kfree(v);
      *pte = 0;
    }
  }
...
80106b65:	8b 45 e0             	mov    -0x20(%ebp),%eax
...
80106b6f:	c3                   	ret    
      if(pa == 0)
80106b70:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106b75:	74 25                	je     80106b9c <deallocuvm.part.0+0x9c>
      kfree(v);
80106b77:	83 ec 0c             	sub    $0xc,%esp
      char *v = P2V(pa);
80106b7a:	05 00 00 00 80       	add    $0x80000000,%eax
80106b7f:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80106b82:	81 c3 00 10 00 00    	add    $0x1000,%ebx
      kfree(v);
80106b88:	50                   	push   %eax
80106b89:	e8 32 b9 ff ff       	call   801024c0 <kfree>
      *pte = 0;
80106b8e:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
  for(; a  < oldsz; a += PGSIZE){
80106b94:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106b97:	83 c4 10             	add    $0x10,%esp
80106b9a:	eb 8c                	jmp    80106b28 <deallocuvm.part.0+0x28>
        panic("kfree");
80106b9c:	83 ec 0c             	sub    $0xc,%esp
80106b9f:	68 66 77 10 80       	push   $0x80107766
...
80106c2e:	e8 4d ba ff ff       	call   80102680 <kalloc>
...
80106c45:	e8 a6 dc ff ff       	call   801048f0 <memset>
...
80106c8d:	68 b0 7d 10 80       	push   $0x80107db0
...
80106ca3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106ca6:	e8 b5 cc ff ff       	call   80103960 <cpuid>
  pd[0] = size-1;
...
80106d30:	a1 c4 46 11 80       	mov    0x801146c4,%eax
...
80106d64:	0f 84 c2 00 00 00    	je     80106e2c <switchuvm+0xec>
  pushcli();
80106d6a:	e8 71 d9 ff ff       	call   801046e0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106d6f:	e8 8c cb ff ff       	call   80103900 <mycpu>
80106d74:	89 c3                	mov    %eax,%ebx
80106d76:	e8 85 cb ff ff       	call   80103900 <mycpu>
80106d7b:	89 c7                	mov    %eax,%edi
80106d7d:	e8 7e cb ff ff       	call   80103900 <mycpu>
80106d82:	83 c7 08             	add    $0x8,%edi
80106d85:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106d88:	e8 73 cb ff ff       	call   80103900 <mycpu>
...
80106e6b:	77 4b                	ja     80106eb8 <inituvm+0x68>
  mem = kalloc();
80106e6d:	e8 0e b8 ff ff       	call   80102680 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106e7f:	e8 6c da ff ff       	call   801048f0 <memset>
...
80106eb2:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106eb3:	e9 d8 da ff ff       	jmp    80104990 <memmove>
    panic("inituvm: more than a page");
80106eb8:	83 ec 0c             	sub    $0xc,%esp
80106ebb:	68 f5 7d 10 80       	push   $0x80107df5
...
80106f20:	68 0f 7e 10 80       	push   $0x80107e0f
...
80106fa8:	68 b0 7e 10 80       	push   $0x80107eb0
...
8010700b:	e8 e0 d8 ff ff       	call   801048f0 <memset>
...
80107039:	76 48                	jbe    80107083 <allocuvm+0xc3>
    mem = kalloc();
8010703b:	e8 40 b6 ff ff       	call   80102680 <kalloc>
...
80107049:	68 2d 7e 10 80       	push   $0x80107e2d
...
80107065:	e8 96 fa ff ff       	call   80106b00 <deallocuvm.part.0>
      return 0;
...
801070ab:	68 45 7e 10 80       	push   $0x80107e45
...
801070c7:	e8 34 fa ff ff       	call   80106b00 <deallocuvm.part.0>
      kfree(mem);
...
80107100:	5d                   	pop    %ebp
80107101:	e9 fa f9 ff ff       	jmp    80106b00 <deallocuvm.part.0>
...
8010713b:	e8 c0 f9 ff ff       	call   80106b00 <deallocuvm.part.0>
...
8010718c:	68 61 7e 10 80       	push   $0x80107e61
...
801071a5:	e8 d6 b4 ff ff       	call   80102680 <kalloc>
...
801071c0:	e8 2b d7 ff ff       	call   801048f0 <memset>
...
8010722b:	a3 c4 46 11 80       	mov    %eax,0x801146c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
8010725c:	68 72 7e 10 80       	push   $0x80107e72
...
8010729e:	89 45 e0             	mov    %eax,-0x20(%ebp)
801072a1:	85 c0                	test   %eax,%eax
801072a3:	0f 84 bd 00 00 00    	je     80107366 <copyuvm+0xd6>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
801072a9:	8b 4d 0c             	mov    0xc(%ebp),%ecx
801072ac:	85 c9                	test   %ecx,%ecx
801072ae:	0f 84 b2 00 00 00    	je     80107366 <copyuvm+0xd6>
801072b4:	31 f6                	xor    %esi,%esi
801072b6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801072bd:	8d 76 00             	lea    0x0(%esi),%esi
  if(*pde & PTE_P){
801072c0:	8b 4d 08             	mov    0x8(%ebp),%ecx
  pde = &pgdir[PDX(va)];
801072c3:	89 f0                	mov    %esi,%eax
801072c5:	c1 e8 16             	shr    $0x16,%eax
  if(*pde & PTE_P){
801072c8:	8b 04 81             	mov    (%ecx,%eax,4),%eax
801072cb:	a8 01                	test   $0x1,%al
801072cd:	75 11                	jne    801072e0 <copyuvm+0x50>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
801072cf:	83 ec 0c             	sub    $0xc,%esp
801072d2:	68 7c 7e 10 80       	push   $0x80107e7c
801072d7:	e8 a4 90 ff ff       	call   80100380 <panic>
801072dc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  return &pgtab[PTX(va)];
801072e0:	89 f2                	mov    %esi,%edx
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
801072e2:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  return &pgtab[PTX(va)];
801072e7:	c1 ea 0a             	shr    $0xa,%edx
801072ea:	81 e2 fc 0f 00 00    	and    $0xffc,%edx
801072f0:	8d 84 10 00 00 00 80 	lea    -0x80000000(%eax,%edx,1),%eax
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
801072f7:	85 c0                	test   %eax,%eax
801072f9:	74 d4                	je     801072cf <copyuvm+0x3f>
    if(!(*pte & PTE_P))
801072fb:	8b 00                	mov    (%eax),%eax
801072fd:	a8 01                	test   $0x1,%al
801072ff:	0f 84 9f 00 00 00    	je     801073a4 <copyuvm+0x114>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80107305:	89 c7                	mov    %eax,%edi
    flags = PTE_FLAGS(*pte);
80107307:	25 ff 0f 00 00       	and    $0xfff,%eax
8010730c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
8010730f:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80107315:	e8 66 b3 ff ff       	call   80102680 <kalloc>
8010731a:	89 c3                	mov    %eax,%ebx
8010731c:	85 c0                	test   %eax,%eax
8010731e:	74 64                	je     80107384 <copyuvm+0xf4>
      goto bad;
...
80107366:	8b 45 e0             	mov    -0x20(%ebp),%eax
...
8010737c:	e8 3f b1 ff ff       	call   801024c0 <kfree>
      goto bad;
80107381:	83 c4 10             	add    $0x10,%esp
  freevm(d);
80107384:	83 ec 0c             	sub    $0xc,%esp
80107387:	ff 75 e0             	push   -0x20(%ebp)
8010738a:	e8 91 fd ff ff       	call   80107120 <freevm>
  return 0;
8010738f:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
...
801073a7:	68 96 7e 10 80       	push   $0x80107e96
801073ac:	e8 cf 8f ff ff       	call   80100380 <panic>
...
801073c3:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(*pde & PTE_P){
801073c6:	8b 55 08             	mov    0x8(%ebp),%edx
  pde = &pgdir[PDX(va)];
801073c9:	89 c1                	mov    %eax,%ecx
801073cb:	c1 e9 16             	shr    $0x16,%ecx
  if(*pde & PTE_P){
801073ce:	8b 14 8a             	mov    (%edx,%ecx,4),%edx
801073d1:	f6 c2 01             	test   $0x1,%dl
801073d4:	0f 84 00 01 00 00    	je     801074da <uva2ka.cold>
  return &pgtab[PTX(va)];
801073da:	c1 e8 0c             	shr    $0xc,%eax
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
801073dd:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
  if((*pte & PTE_P) == 0)
    return 0;
  if((*pte & PTE_U) == 0)
    return 0;
...
801073e3:	5d                   	pop    %ebp
  return &pgtab[PTX(va)];
801073e4:	25 ff 03 00 00       	and    $0x3ff,%eax
  if((*pte & PTE_P) == 0)
801073e9:	8b 84 82 00 00 00 80 	mov    -0x80000000(%edx,%eax,4),%eax
  if((*pte & PTE_U) == 0)
801073f0:	89 c2                	mov    %eax,%edx
  return (char*)P2V(PTE_ADDR(*pte));
801073f2:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  if((*pte & PTE_U) == 0)
801073f7:	83 e2 05             	and    $0x5,%edx
  return (char*)P2V(PTE_ADDR(*pte));
801073fa:	05 00 00 00 80       	add    $0x80000000,%eax
801073ff:	83 fa 05             	cmp    $0x5,%edx
80107402:	ba 00 00 00 00       	mov    $0x0,%edx
80107407:	0f 45 c2             	cmovne %edx,%eax
}
8010740a:	c3                   	ret    
...
80107419:	8b 75 14             	mov    0x14(%ebp),%esi
8010741c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010741f:	8b 55 10             	mov    0x10(%ebp),%edx
  char *buf, *pa0;
  uint n, va0;

  buf = (char*)p;
  while(len > 0){
80107422:	85 f6                	test   %esi,%esi
80107424:	75 51                	jne    80107477 <copyout+0x67>
80107426:	e9 a5 00 00 00       	jmp    801074d0 <copyout+0xc0>
8010742b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
8010742f:	90                   	nop
  return (char*)P2V(PTE_ADDR(*pte));
80107430:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
80107436:	8d 8b 00 00 00 80    	lea    -0x80000000(%ebx),%ecx
    va0 = (uint)PGROUNDDOWN(va);
    pa0 = uva2ka(pgdir, (char*)va0);
    if(pa0 == 0)
8010743c:	81 fb 00 00 00 80    	cmp    $0x80000000,%ebx
80107442:	74 75                	je     801074b9 <copyout+0xa9>
      return -1;
    n = PGSIZE - (va - va0);
80107444:	89 fb                	mov    %edi,%ebx
    if(n > len)
      n = len;
    memmove(pa0 + (va - va0), buf, n);
80107446:	89 55 10             	mov    %edx,0x10(%ebp)
    n = PGSIZE - (va - va0);
80107449:	29 c3                	sub    %eax,%ebx
8010744b:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80107451:	39 f3                	cmp    %esi,%ebx
80107453:	0f 47 de             	cmova  %esi,%ebx
    memmove(pa0 + (va - va0), buf, n);
80107456:	29 f8                	sub    %edi,%eax
80107458:	83 ec 04             	sub    $0x4,%esp
8010745b:	01 c1                	add    %eax,%ecx
8010745d:	53                   	push   %ebx
8010745e:	52                   	push   %edx
8010745f:	51                   	push   %ecx
80107460:	e8 2b d5 ff ff       	call   80104990 <memmove>
    len -= n;
    buf += n;
80107465:	8b 55 10             	mov    0x10(%ebp),%edx
    va = va0 + PGSIZE;
80107468:	8d 87 00 10 00 00    	lea    0x1000(%edi),%eax
  while(len > 0){
8010746e:	83 c4 10             	add    $0x10,%esp
    buf += n;
80107471:	01 da                	add    %ebx,%edx
  while(len > 0){
80107473:	29 de                	sub    %ebx,%esi
80107475:	74 59                	je     801074d0 <copyout+0xc0>
  if(*pde & PTE_P){
80107477:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pde = &pgdir[PDX(va)];
8010747a:	89 c1                	mov    %eax,%ecx
    va0 = (uint)PGROUNDDOWN(va);
8010747c:	89 c7                	mov    %eax,%edi
  pde = &pgdir[PDX(va)];
8010747e:	c1 e9 16             	shr    $0x16,%ecx
    va0 = (uint)PGROUNDDOWN(va);
80107481:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
  if(*pde & PTE_P){
80107487:	8b 0c 8b             	mov    (%ebx,%ecx,4),%ecx
8010748a:	f6 c1 01             	test   $0x1,%cl
8010748d:	0f 84 4e 00 00 00    	je     801074e1 <copyout.cold>
  return &pgtab[PTX(va)];
80107493:	89 fb                	mov    %edi,%ebx
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80107495:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
  return &pgtab[PTX(va)];
8010749b:	c1 eb 0c             	shr    $0xc,%ebx
8010749e:	81 e3 ff 03 00 00    	and    $0x3ff,%ebx
  if((*pte & PTE_P) == 0)
801074a4:	8b 9c 99 00 00 00 80 	mov    -0x80000000(%ecx,%ebx,4),%ebx
  if((*pte & PTE_U) == 0)
801074ab:	89 d9                	mov    %ebx,%ecx
801074ad:	83 e1 05             	and    $0x5,%ecx
801074b0:	83 f9 05             	cmp    $0x5,%ecx
801074b3:	0f 84 77 ff ff ff    	je     80107430 <copyout+0x20>
  }
  return 0;
}
...
801074da <uva2ka.cold>:
  if((*pte & PTE_P) == 0)
801074da:	a1 00 00 00 00       	mov    0x0,%eax
801074df:	0f 0b                	ud2    

801074e1 <copyout.cold>:
801074e1:	a1 00 00 00 00       	mov    0x0,%eax
801074e6:	0f 0b                	ud2    
