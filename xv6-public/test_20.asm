...
int main(int argc, char *argv[])
{
   ...
   ppid = getpid();
  11:	e8 af 06 00 00       	call   6c5 <getpid>
  ...
  20:	6a 00                	push   $0x0
   ppid = getpid();
  22:	a3 64 0f 00 00       	mov    %eax,0xf64
   int arg1 = 11, arg2 = 22;
  27:	c7 45 f4 16 00 00 00 	movl   $0x16,-0xc(%ebp)
   size = (unsigned int)sbrk(0);
  2e:	e8 9a 06 00 00       	call   6cd <sbrk>

   int thread_pid = thread_create(worker, &arg1, &arg2);
  33:	83 c4 0c             	add    $0xc,%esp
   size = (unsigned int)sbrk(0);
  36:	a3 5c 0f 00 00       	mov    %eax,0xf5c
   int thread_pid = thread_create(worker, &arg1, &arg2);
  ...
  66:	e8 45 07 00 00       	call   7b0 <printf>
   exit();
  6b:	e8 d5 05 00 00       	call   645 <exit>
   assert(join_pid > 0);
  70:	6a 27                	push   $0x27
  ...
  a5:	58                   	pop    %eax
  a6:	ff 35 64 0f 00 00    	push   0xf64
  ac:	e8 c4 05 00 00       	call   675 <kill>
  b1:	e8 8f 05 00 00       	call   645 <exit>
   assert(thread_pid > 0);
  b6:	6a 24                	push   $0x24
...
void worker2(void *arg1, void *arg2)
{
  ...
  e3:	83 ec 14             	sub    $0x14,%esp
   lock_acquire(&lock);
  e6:	68 58 0f 00 00       	push   $0xf58
  eb:	e8 20 05 00 00       	call   610 <lock_acquire>
   assert((unsigned int)sbrk(0) == size);
  f0:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  f7:	e8 d1 05 00 00       	call   6cd <sbrk>
  fc:	83 c4 10             	add    $0x10,%esp
  ff:	3b 05 5c 0f 00 00    	cmp    0xf5c,%eax
 ...
 13c:	59                   	pop    %ecx
 13d:	ff 35 64 0f 00 00    	push   0xf64
 143:	e8 2d 05 00 00       	call   675 <kill>
 148:	e8 f8 04 00 00       	call   645 <exit>
   lock_release(&lock);
 14d:	83 ec 0c             	sub    $0xc,%esp
   global++;
 150:	83 05 60 0f 00 00 01 	addl   $0x1,0xf60
   lock_release(&lock);
 157:	68 58 0f 00 00       	push   $0xf58
 15c:	e8 cf 04 00 00       	call   630 <lock_release>
   lock_acquire(&lock2);
 161:	c7 04 24 54 0f 00 00 	movl   $0xf54,(%esp)
 168:	e8 a3 04 00 00       	call   610 <lock_acquire>
   assert((unsigned int)sbrk(0) == size);
 16d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 174:	e8 54 05 00 00       	call   6cd <sbrk>
 179:	83 c4 10             	add    $0x10,%esp
 17c:	3b 05 5c 0f 00 00    	cmp    0xf5c,%eax
 ...
 188:	83 ec 0c             	sub    $0xc,%esp
   global++;
 18b:	83 05 60 0f 00 00 01 	addl   $0x1,0xf60
   lock_release(&lock2);
 192:	68 54 0f 00 00       	push   $0xf54
 197:	e8 94 04 00 00       	call   630 <lock_release>

   
   exit();
 19c:	e8 a4 04 00 00       	call   645 <exit>
...
void worker(void *arg1, void *arg2) {
 ...
 1b3:	83 ec 14             	sub    $0x14,%esp
   lock_init(&lock);
 1b6:	68 58 0f 00 00       	push   $0xf58
 1bb:	e8 40 04 00 00       	call   600 <lock_init>
   lock_init(&lock2);
 1c0:	c7 04 24 54 0f 00 00 	movl   $0xf54,(%esp)
 1c7:	e8 34 04 00 00       	call   600 <lock_init>
   lock_acquire(&lock);
 1cc:	c7 04 24 58 0f 00 00 	movl   $0xf58,(%esp)
 1d3:	e8 38 04 00 00       	call   610 <lock_acquire>
   lock_acquire(&lock2);
 1d8:	c7 04 24 54 0f 00 00 	movl   $0xf54,(%esp)
 ...
 203:	6a 00                	push   $0x0
 205:	e8 c3 04 00 00       	call   6cd <sbrk>

   while (global < num_threads) {
 20a:	83 c4 10             	add    $0x10,%esp
   size = (unsigned int)sbrk(0);
 20d:	a3 5c 0f 00 00       	mov    %eax,0xf5c
   while (global < num_threads) {
 212:	a1 50 0f 00 00       	mov    0xf50,%eax
 217:	39 05 60 0f 00 00    	cmp    %eax,0xf60
 21d:	7d 36                	jge    255 <worker+0xa5>
 21f:	90                   	nop
      lock_release(&lock);
 220:	83 ec 0c             	sub    $0xc,%esp
 223:	68 58 0f 00 00       	push   $0xf58
 228:	e8 03 04 00 00       	call   630 <lock_release>
      sleep(100);
 22d:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
 234:	e8 9c 04 00 00       	call   6d5 <sleep>
      lock_acquire(&lock);
 239:	c7 04 24 58 0f 00 00 	movl   $0xf58,(%esp)
 240:	e8 cb 03 00 00       	call   610 <lock_acquire>
   while (global < num_threads) {
 245:	a1 50 0f 00 00       	mov    0xf50,%eax
 24a:	83 c4 10             	add    $0x10,%esp
 24d:	39 05 60 0f 00 00    	cmp    %eax,0xf60
 253:	7c cb                	jl     220 <worker+0x70>
   }

   global = 0;
 255:	c7 05 60 0f 00 00 00 	movl   $0x0,0xf60
 25c:	00 00 00 
   sbrk(10000);
 25f:	83 ec 0c             	sub    $0xc,%esp
 262:	68 10 27 00 00       	push   $0x2710
 267:	e8 61 04 00 00       	call   6cd <sbrk>
   size = (unsigned int)sbrk(0);
 26c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 273:	e8 55 04 00 00       	call   6cd <sbrk>
   lock_release(&lock);
 278:	c7 04 24 58 0f 00 00 	movl   $0xf58,(%esp)
   size = (unsigned int)sbrk(0);
 27f:	a3 5c 0f 00 00       	mov    %eax,0xf5c
   lock_release(&lock);
 284:	e8 a7 03 00 00       	call   630 <lock_release>

   while (global < num_threads) {
 289:	a1 50 0f 00 00       	mov    0xf50,%eax
 28e:	83 c4 10             	add    $0x10,%esp
 291:	39 05 60 0f 00 00    	cmp    %eax,0xf60
 297:	7d 3c                	jge    2d5 <worker+0x125>
 299:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      lock_release(&lock2);
 2a0:	83 ec 0c             	sub    $0xc,%esp
 2a3:	68 54 0f 00 00       	push   $0xf54
 2a8:	e8 83 03 00 00       	call   630 <lock_release>
      sleep(100);
 2ad:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
 2b4:	e8 1c 04 00 00       	call   6d5 <sleep>
      lock_acquire(&lock2);
 2b9:	c7 04 24 54 0f 00 00 	movl   $0xf54,(%esp)
 2c0:	e8 4b 03 00 00       	call   610 <lock_acquire>
   while (global < num_threads) {
 2c5:	a1 50 0f 00 00       	mov    0xf50,%eax
 2ca:	83 c4 10             	add    $0x10,%esp
 2cd:	39 05 60 0f 00 00    	cmp    %eax,0xf60
 2d3:	7c cb                	jl     2a0 <worker+0xf0>
   }
   lock_release(&lock2);
 2d5:	83 ec 0c             	sub    $0xc,%esp
 2d8:	68 54 0f 00 00       	push   $0xf54
 ...
 2ec:	7e 05                	jle    2f3 <worker+0x143>
   ...
   exit();
 2ee:	e8 52 03 00 00       	call   645 <exit>
   assert(nested_join_pid > 0);
 2f3:	6a 5d                	push   $0x5d
 ...
 328:	59                   	pop    %ecx
 329:	ff 35 64 0f 00 00    	push   0xf64
 32f:	e8 41 03 00 00       	call   675 <kill>
 334:	e8 0c 03 00 00       	call   645 <exit>
    assert(nested_thread_id > 0);
 339:	6a 47                	push   $0x47
 ...
 489:	31 db                	xor    %ebx,%ebx
{
 ...
 495:	57                   	push   %edi
 496:	6a 00                	push   $0x0
 498:	e8 c0 01 00 00       	call   65d <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 4fd:	e8 83 01 00 00       	call   685 <open>
  if(fd < 0)
 ...
 511:	50                   	push   %eax
 512:	e8 86 01 00 00       	call   69d <fstat>
  close(fd);
 517:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 51a:	89 c6                	mov    %eax,%esi
  close(fd);
 51c:	e8 4c 01 00 00       	call   66d <close>
  return r;
...
free(void *ap)
{
 ...
 951:	a1 68 0f 00 00       	mov    0xf68,%eax
{
 ...
 991:	5b                   	pop    %ebx
  freep = p;
 992:	89 15 68 0f 00 00    	mov    %edx,0xf68
}
 998:	5e                   	pop    %esi
 999:	5f                   	pop    %edi
 99a:	5d                   	pop    %ebp
 ...
 9c9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 9cc:	89 15 68 0f 00 00    	mov    %edx,0xf68
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 9e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 9ec:	8b 3d 68 0f 00 00    	mov    0xf68,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 a2f:	73 4f                	jae    a80 <malloc+0xa0>
    ...
    if(p == freep)
 a31:	8b 3d 68 0f 00 00    	mov    0xf68,%edi
 ...
 a5a:	e8 f1 fe ff ff       	call   950 <free>
  return freep;
 a5f:	8b 15 68 0f 00 00    	mov    0xf68,%edx
 ...
 a8c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 a8f:	89 15 68 0f 00 00    	mov    %edx,0xf68
}
 ...
 a9f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 aa0:	c7 05 68 0f 00 00 6c 	movl   $0xf6c,0xf68
 aa7:	0f 00 00 
    base.s.size = 0;
 aaa:	bf 6c 0f 00 00       	mov    $0xf6c,%edi
    base.s.ptr = freep = prevp = &base;
 aaf:	c7 05 6c 0f 00 00 6c 	movl   $0xf6c,0xf6c
 ab6:	0f 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 ab9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 abb:	c7 05 70 0f 00 00 00 	movl   $0x0,0xf70
 ac2:	00 00 00 
    if(p->s.size >= nunits){
