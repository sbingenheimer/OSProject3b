...
main(int argc, char *argv[])
{
  ...
  11:	83 ec 18             	sub    $0x18,%esp
   ppid = getpid();
  14:	e8 1c 08 00 00       	call   835 <getpid>

   assert(fib(28) == 317811);
  19:	83 ec 0c             	sub    $0xc,%esp
  1c:	6a 1c                	push   $0x1c
   ppid = getpid();
  1e:	a3 14 11 00 00       	mov    %eax,0x1114
   assert(fib(28) == 317811);
  ...
  36:	83 3d 0c 11 00 00 00 	cmpl   $0x0,0x110c
   int arg1 = 11, arg2 = 22;
  ...
  5f:	90                   	nop
  60:	a1 0c 11 00 00       	mov    0x110c,%eax
  ...
  b7:	59                   	pop    %ecx
  b8:	ff 35 14 11 00 00    	push   0x1114
  be:	e8 22 07 00 00       	call   7e5 <kill>
  c3:	e8 ed 06 00 00       	call   7b5 <exit>
   assert(fib(28) == 317811);
  c8:	6a 28                	push   $0x28
  ...
  f3:	39 1d 0c 11 00 00    	cmp    %ebx,0x110c
 ...
 12d:	e8 ee 07 00 00       	call   920 <printf>
   exit();
 132:	e8 7e 06 00 00       	call   7b5 <exit>
...
worker(void *arg1, void *arg2) {
 ...
 366:	75 2a                	jne    392 <worker+0x42>
   assert(global == 1);
 368:	83 3d 10 11 00 00 01 	cmpl   $0x1,0x1110
 ...
 3c7:	59                   	pop    %ecx
 3c8:	ff 35 14 11 00 00    	push   0x1114
 3ce:	e8 12 04 00 00       	call   7e5 <kill>
 3d3:	e8 dd 03 00 00       	call   7b5 <exit>
   assert(tmp1 == 11);
 3d8:	6a 3e                	push   $0x3e
 ...
 4b7:	e9 f1 fe ff ff       	jmp    3ad <worker+0x5d>
   exit();
 4bc:	e8 f4 02 00 00       	call   7b5 <exit>
 ...
 5f9:	31 db                	xor    %ebx,%ebx
{
 ...
 605:	57                   	push   %edi
 606:	6a 00                	push   $0x0
 608:	e8 c0 01 00 00       	call   7cd <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 66d:	e8 83 01 00 00       	call   7f5 <open>
  if(fd < 0)
 ...
 681:	50                   	push   %eax
 682:	e8 86 01 00 00       	call   80d <fstat>
  close(fd);
 687:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 68a:	89 c6                	mov    %eax,%esi
  close(fd);
 68c:	e8 4c 01 00 00       	call   7dd <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 72b:	e8 20 04 00 00       	call   b50 <malloc>
  void * stack;

  //setting up pagealignment
  if (((uint)stackspace % PGSIZE) == 0){
 730:	83 c4 10             	add    $0x10,%esp
 733:	a9 ff 0f 00 00       	test   $0xfff,%eax
 738:	74 05                	je     73f <thread_create+0x1f>
    stack = stackspace;
  }else{
    stack = stackspace + (PGSIZE - ((uint)stackspace - PGSIZE));
 73a:	b8 00 20 00 00       	mov    $0x2000,%eax
  }

  //call clone
  int toret = clone(start_routine, arg1, arg2, stack);
 73f:	50                   	push   %eax
 740:	ff 75 10             	push   0x10(%ebp)
 743:	ff 75 0c             	push   0xc(%ebp)
 746:	ff 75 08             	push   0x8(%ebp)
 749:	e8 07 01 00 00       	call   855 <clone>
  if (toret != -1){
    return toret;
  }else {
    return -1;
...
void lock_init(lock_t *lock){
 ...
 776:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
 77c:	5d                   	pop    %ebp
 77d:	c3                   	ret    
...
void lock_release(lock_t *lock){
 ...
 7a8:	f0 87 02             	lock xchg %eax,(%edx)
  xchg(&lock->locked, 0);
 7ab:	5d                   	pop    %ebp
 7ac:	c3                   	ret    
...
SYSCALL(fork)
 7ad:	b8 01 00 00 00       	mov    $0x1,%eax
 7b2:	cd 40                	int    $0x40
 7b4:	c3                   	ret    

000007b5 <exit>:
SYSCALL(exit)
 7b5:	b8 02 00 00 00       	mov    $0x2,%eax
 7ba:	cd 40                	int    $0x40
 7bc:	c3                   	ret    

000007bd <wait>:
SYSCALL(wait)
 7bd:	b8 03 00 00 00       	mov    $0x3,%eax
 7c2:	cd 40                	int    $0x40
 7c4:	c3                   	ret    

000007c5 <pipe>:
SYSCALL(pipe)
 7c5:	b8 04 00 00 00       	mov    $0x4,%eax
 7ca:	cd 40                	int    $0x40
 7cc:	c3                   	ret    

000007cd <read>:
SYSCALL(read)
 7cd:	b8 05 00 00 00       	mov    $0x5,%eax
 7d2:	cd 40                	int    $0x40
 7d4:	c3                   	ret    

000007d5 <write>:
SYSCALL(write)
 7d5:	b8 10 00 00 00       	mov    $0x10,%eax
 7da:	cd 40                	int    $0x40
 7dc:	c3                   	ret    

000007dd <close>:
SYSCALL(close)
 7dd:	b8 15 00 00 00       	mov    $0x15,%eax
 7e2:	cd 40                	int    $0x40
 7e4:	c3                   	ret    

000007e5 <kill>:
SYSCALL(kill)
 7e5:	b8 06 00 00 00       	mov    $0x6,%eax
 7ea:	cd 40                	int    $0x40
 7ec:	c3                   	ret    

000007ed <exec>:
SYSCALL(exec)
 7ed:	b8 07 00 00 00       	mov    $0x7,%eax
 7f2:	cd 40                	int    $0x40
 7f4:	c3                   	ret    

000007f5 <open>:
SYSCALL(open)
 7f5:	b8 0f 00 00 00       	mov    $0xf,%eax
 7fa:	cd 40                	int    $0x40
 7fc:	c3                   	ret    

000007fd <mknod>:
SYSCALL(mknod)
 7fd:	b8 11 00 00 00       	mov    $0x11,%eax
 802:	cd 40                	int    $0x40
 804:	c3                   	ret    

00000805 <unlink>:
SYSCALL(unlink)
 805:	b8 12 00 00 00       	mov    $0x12,%eax
 80a:	cd 40                	int    $0x40
 80c:	c3                   	ret    

0000080d <fstat>:
SYSCALL(fstat)
 80d:	b8 08 00 00 00       	mov    $0x8,%eax
 812:	cd 40                	int    $0x40
 814:	c3                   	ret    

00000815 <link>:
SYSCALL(link)
 815:	b8 13 00 00 00       	mov    $0x13,%eax
 81a:	cd 40                	int    $0x40
 81c:	c3                   	ret    

0000081d <mkdir>:
SYSCALL(mkdir)
 81d:	b8 14 00 00 00       	mov    $0x14,%eax
 822:	cd 40                	int    $0x40
 824:	c3                   	ret    

00000825 <chdir>:
SYSCALL(chdir)
 825:	b8 09 00 00 00       	mov    $0x9,%eax
 82a:	cd 40                	int    $0x40
 82c:	c3                   	ret    

0000082d <dup>:
SYSCALL(dup)
 82d:	b8 0a 00 00 00       	mov    $0xa,%eax
 832:	cd 40                	int    $0x40
 834:	c3                   	ret    

00000835 <getpid>:
SYSCALL(getpid)
 835:	b8 0b 00 00 00       	mov    $0xb,%eax
 83a:	cd 40                	int    $0x40
 83c:	c3                   	ret    

0000083d <sbrk>:
SYSCALL(sbrk)
 83d:	b8 0c 00 00 00       	mov    $0xc,%eax
 842:	cd 40                	int    $0x40
 844:	c3                   	ret    

00000845 <sleep>:
SYSCALL(sleep)
 845:	b8 0d 00 00 00       	mov    $0xd,%eax
 84a:	cd 40                	int    $0x40
 84c:	c3                   	ret    

0000084d <uptime>:
SYSCALL(uptime)
 84d:	b8 0e 00 00 00       	mov    $0xe,%eax
 852:	cd 40                	int    $0x40
 854:	c3                   	ret    

00000855 <clone>:
SYSCALL(clone)
 855:	b8 16 00 00 00       	mov    $0x16,%eax
 85a:	cd 40                	int    $0x40
 85c:	c3                   	ret    

0000085d <join>:
SYSCALL(join)
 85d:	b8 17 00 00 00       	mov    $0x17,%eax
 862:	cd 40                	int    $0x40
 864:	c3                   	ret    
 ...
 87c:	89 d1                	mov    %edx,%ecx
{
 ...
 8ee:	56                   	push   %esi
 8ef:	57                   	push   %edi
 8f0:	e8 e0 fe ff ff       	call   7d5 <write>
  while(--i >= 0)
 ...
 929:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 965:	57                   	push   %edi
 966:	56                   	push   %esi
 967:	e8 69 fe ff ff       	call   7d5 <write>
 ...
 9be:	e8 12 fe ff ff       	call   7d5 <write>
        putc(fd, c);
 ...
 9cf:	57                   	push   %edi
 9d0:	56                   	push   %esi
 9d1:	e8 ff fd ff ff       	call   7d5 <write>
        putc(fd, c);
 ...
 a3b:	57                   	push   %edi
 a3c:	56                   	push   %esi
 a3d:	e8 93 fd ff ff       	call   7d5 <write>
        while(*s != 0){
 ...
 a7c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 a7f:	e8 51 fd ff ff       	call   7d5 <write>
        ap++;
...
free(void *ap)
{
 ...
 ac1:	a1 18 11 00 00       	mov    0x1118,%eax
{
 ...
 b01:	5b                   	pop    %ebx
  freep = p;
 b02:	89 15 18 11 00 00    	mov    %edx,0x1118
}
 b08:	5e                   	pop    %esi
 b09:	5f                   	pop    %edi
 b0a:	5d                   	pop    %ebp
 ...
 b39:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 b3c:	89 15 18 11 00 00    	mov    %edx,0x1118
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 b59:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 b5c:	8b 3d 18 11 00 00    	mov    0x1118,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 b9f:	73 4f                	jae    bf0 <malloc+0xa0>
    ...
    if(p == freep)
 ba1:	8b 3d 18 11 00 00    	mov    0x1118,%edi
 ...
 bb3:	e8 85 fc ff ff       	call   83d <sbrk>
  if(p == (char*)-1)
 ...
 bca:	e8 f1 fe ff ff       	call   ac0 <free>
  return freep;
 bcf:	8b 15 18 11 00 00    	mov    0x1118,%edx
 ...
 bfc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 bff:	89 15 18 11 00 00    	mov    %edx,0x1118
}
 ...
 c0f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 c10:	c7 05 18 11 00 00 1c 	movl   $0x111c,0x1118
 c17:	11 00 00 
    base.s.size = 0;
 c1a:	bf 1c 11 00 00       	mov    $0x111c,%edi
    base.s.ptr = freep = prevp = &base;
 c1f:	c7 05 1c 11 00 00 1c 	movl   $0x111c,0x111c
 c26:	11 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 c29:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 c2b:	c7 05 20 11 00 00 00 	movl   $0x0,0x1120
 c32:	00 00 00 
    if(p->s.size >= nunits){
