...
main(int argc, char *argv[])
{
  ...
  10:	83 ec 1c             	sub    $0x1c,%esp
   ppid = getpid();
  13:	e8 ed 04 00 00       	call   505 <getpid>
   void *stack, *p = malloc(PGSIZE*2);
  18:	83 ec 0c             	sub    $0xc,%esp
  1b:	68 00 20 00 00       	push   $0x2000
   ppid = getpid();
  20:	a3 60 0d 00 00       	mov    %eax,0xd60
   void *stack, *p = malloc(PGSIZE*2);
  ...
  4f:	e8 d1 04 00 00       	call   525 <clone>
   assert(clone_pid > 0);
  ...
  61:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
   while(global != 5);
  68:	8b 15 5c 0d 00 00    	mov    0xd5c,%edx
  ...
  87:	e8 a1 04 00 00       	call   52d <join>
  ...
  c8:	5b                   	pop    %ebx
  c9:	ff 35 60 0d 00 00    	push   0xd60
  cf:	e8 e1 03 00 00       	call   4b5 <kill>
  d4:	e8 ac 03 00 00       	call   485 <exit>
     stack = p + (PGSIZE - (uint)p % PGSIZE);
  ...
  e9:	e8 a2 06 00 00       	call   790 <free>
   exit();
  ee:	e8 92 03 00 00       	call   485 <exit>
   assert(clone_pid > 0);
  f3:	6a 23                	push   $0x23
...
worker(void *arg1, void *arg2) {
 ...
 133:	83 ec 08             	sub    $0x8,%esp
   assert(global == 1);
 136:	a1 5c 0d 00 00       	mov    0xd5c,%eax
 ...
 175:	59                   	pop    %ecx
 176:	ff 35 60 0d 00 00    	push   0xd60
 17c:	e8 34 03 00 00       	call   4b5 <kill>
 181:	e8 ff 02 00 00       	call   485 <exit>
   global = 5;
 186:	c7 05 5c 0d 00 00 05 	movl   $0x5,0xd5c
 18d:	00 00 00 
   exit();
 190:	e8 f0 02 00 00       	call   485 <exit>
 ...
 2c9:	31 db                	xor    %ebx,%ebx
{
 ...
 2d5:	57                   	push   %edi
 2d6:	6a 00                	push   $0x0
 2d8:	e8 c0 01 00 00       	call   49d <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 33d:	e8 83 01 00 00       	call   4c5 <open>
  if(fd < 0)
 ...
 351:	50                   	push   %eax
 352:	e8 86 01 00 00       	call   4dd <fstat>
  close(fd);
 357:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 35a:	89 c6                	mov    %eax,%esi
  close(fd);
 35c:	e8 4c 01 00 00       	call   4ad <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 3fb:	e8 20 04 00 00       	call   820 <malloc>
  void * stack;

  //setting up pagealignment
  if (((uint)stackspace % PGSIZE) == 0){
 400:	83 c4 10             	add    $0x10,%esp
 403:	a9 ff 0f 00 00       	test   $0xfff,%eax
 408:	74 05                	je     40f <thread_create+0x1f>
    stack = stackspace;
  }else{
    stack = stackspace + (PGSIZE - ((uint)stackspace - PGSIZE));
 40a:	b8 00 20 00 00       	mov    $0x2000,%eax
  }

  //call clone
  int toret = clone(start_routine, arg1, arg2, stack);
 40f:	50                   	push   %eax
 410:	ff 75 10             	push   0x10(%ebp)
 413:	ff 75 0c             	push   0xc(%ebp)
 416:	ff 75 08             	push   0x8(%ebp)
 419:	e8 07 01 00 00       	call   525 <clone>
  if (toret != -1){
    return toret;
  }else {
    return -1;
...
free(void *ap)
{
 ...
 791:	a1 64 0d 00 00       	mov    0xd64,%eax
{
 ...
 7d1:	5b                   	pop    %ebx
  freep = p;
 7d2:	89 15 64 0d 00 00    	mov    %edx,0xd64
}
 7d8:	5e                   	pop    %esi
 7d9:	5f                   	pop    %edi
 7da:	5d                   	pop    %ebp
 ...
 809:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 80c:	89 15 64 0d 00 00    	mov    %edx,0xd64
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 829:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 82c:	8b 3d 64 0d 00 00    	mov    0xd64,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 86f:	73 4f                	jae    8c0 <malloc+0xa0>
    ...
    if(p == freep)
 871:	8b 3d 64 0d 00 00    	mov    0xd64,%edi
 ...
 89a:	e8 f1 fe ff ff       	call   790 <free>
  return freep;
 89f:	8b 15 64 0d 00 00    	mov    0xd64,%edx
 ...
 8cc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 8cf:	89 15 64 0d 00 00    	mov    %edx,0xd64
}
 ...
 8df:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 8e0:	c7 05 64 0d 00 00 68 	movl   $0xd68,0xd64
 8e7:	0d 00 00 
    base.s.size = 0;
 8ea:	bf 68 0d 00 00       	mov    $0xd68,%edi
    base.s.ptr = freep = prevp = &base;
 8ef:	c7 05 68 0d 00 00 68 	movl   $0xd68,0xd68
 8f6:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8f9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 8fb:	c7 05 6c 0d 00 00 00 	movl   $0x0,0xd6c
 902:	00 00 00 
    if(p->s.size >= nunits){
