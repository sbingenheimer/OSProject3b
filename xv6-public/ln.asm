   ...
   a:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  20:	e8 ab 04 00 00       	call   4d0 <printf>
    exit();
  25:	e8 3b 03 00 00       	call   365 <exit>
  }
  ...
  32:	e8 8e 03 00 00       	call   3c5 <link>
  37:	83 c4 10             	add    $0x10,%esp
  3a:	85 c0                	test   %eax,%eax
  3c:	78 05                	js     43 <main+0x43>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
  exit();
  3e:	e8 22 03 00 00       	call   365 <exit>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
 ...
 42c:	89 d1                	mov    %edx,%ecx
{
 ...
 459:	0f b6 92 80 08 00 00 	movzbl 0x880(%edx),%edx
 ...
 4d9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 549:	ff 24 85 28 08 00 00 	jmp    *0x828(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 657:	90                   	nop
          s = "(null)";
 658:	ba 1f 08 00 00       	mov    $0x81f,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 671:	a1 d4 0b 00 00       	mov    0xbd4,%eax
{
 ...
 6b1:	5b                   	pop    %ebx
  freep = p;
 6b2:	89 15 d4 0b 00 00    	mov    %edx,0xbd4
}
 6b8:	5e                   	pop    %esi
 6b9:	5f                   	pop    %edi
 6ba:	5d                   	pop    %ebp
 ...
 6e9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ec:	89 15 d4 0b 00 00    	mov    %edx,0xbd4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 3d d4 0b 00 00    	mov    0xbd4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 74f:	73 4f                	jae    7a0 <malloc+0xa0>
    ...
    if(p == freep)
 751:	8b 3d d4 0b 00 00    	mov    0xbd4,%edi
 ...
 77a:	e8 f1 fe ff ff       	call   670 <free>
  return freep;
 77f:	8b 15 d4 0b 00 00    	mov    0xbd4,%edx
 ...
 7ac:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7af:	89 15 d4 0b 00 00    	mov    %edx,0xbd4
}
 ...
 7bf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7c0:	c7 05 d4 0b 00 00 d8 	movl   $0xbd8,0xbd4
 7c7:	0b 00 00 
    base.s.size = 0;
 7ca:	bf d8 0b 00 00       	mov    $0xbd8,%edi
    base.s.ptr = freep = prevp = &base;
 7cf:	c7 05 d8 0b 00 00 d8 	movl   $0xbd8,0xbd8
 7d6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7d9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7db:	c7 05 dc 0b 00 00 00 	movl   $0x0,0xbdc
 7e2:	00 00 00 
    if(p->s.size >= nunits){
