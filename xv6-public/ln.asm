   ...
   a:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  20:	e8 8b 04 00 00       	call   4b0 <printf>
    exit();
  25:	e8 1b 03 00 00       	call   345 <exit>
  }
  ...
  32:	e8 6e 03 00 00       	call   3a5 <link>
  37:	83 c4 10             	add    $0x10,%esp
  3a:	85 c0                	test   %eax,%eax
  3c:	78 05                	js     43 <main+0x43>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
  exit();
  3e:	e8 02 03 00 00       	call   345 <exit>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
...
free(void *ap)
{
 ...
 651:	a1 ac 0b 00 00       	mov    0xbac,%eax
{
 ...
 691:	5b                   	pop    %ebx
  freep = p;
 692:	89 15 ac 0b 00 00    	mov    %edx,0xbac
}
 698:	5e                   	pop    %esi
 699:	5f                   	pop    %edi
 69a:	5d                   	pop    %ebp
 ...
 6c9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6cc:	89 15 ac 0b 00 00    	mov    %edx,0xbac
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ec:	8b 3d ac 0b 00 00    	mov    0xbac,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 72f:	73 4f                	jae    780 <malloc+0xa0>
    ...
    if(p == freep)
 731:	8b 3d ac 0b 00 00    	mov    0xbac,%edi
 ...
 75a:	e8 f1 fe ff ff       	call   650 <free>
  return freep;
 75f:	8b 15 ac 0b 00 00    	mov    0xbac,%edx
 ...
 78c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 78f:	89 15 ac 0b 00 00    	mov    %edx,0xbac
}
 ...
 79f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7a0:	c7 05 ac 0b 00 00 b0 	movl   $0xbb0,0xbac
 7a7:	0b 00 00 
    base.s.size = 0;
 7aa:	bf b0 0b 00 00       	mov    $0xbb0,%edi
    base.s.ptr = freep = prevp = &base;
 7af:	c7 05 b0 0b 00 00 b0 	movl   $0xbb0,0xbb0
 7b6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7b9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7bb:	c7 05 b4 0b 00 00 00 	movl   $0x0,0xbb4
 7c2:	00 00 00 
    if(p->s.size >= nunits){
