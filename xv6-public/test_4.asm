...
main(int argc, char *argv[])
{
  ...
  1b:	68 00 20 00 00       	push   $0x2000
   ppid = getpid();
  20:	a3 c4 0d 00 00       	mov    %eax,0xdc4
   void *stack, *p = malloc(PGSIZE * 2);
  ...
  4d:	e8 03 05 00 00       	call   555 <clone>
  ...
  8f:	5b                   	pop    %ebx
  90:	ff 35 c4 0d 00 00    	push   0xdc4
  96:	e8 4a 04 00 00       	call   4e5 <kill>
  9b:	e8 15 04 00 00       	call   4b5 <exit>

   stack = sbrk(0);
  a0:	83 ec 0c             	sub    $0xc,%esp
  a3:	6a 00                	push   $0x0
  a5:	e8 93 04 00 00       	call   53d <sbrk>
 ...
 188:	e8 c8 03 00 00       	call   555 <clone>
 ...
 1ad:	e8 0e 06 00 00       	call   7c0 <free>
   exit();
 1b2:	e8 fe 02 00 00       	call   4b5 <exit>
...
worker(void *arg1, void *arg2) {
 ...
 1c3:	83 ec 08             	sub    $0x8,%esp
   exit();
 1c6:	e8 ea 02 00 00       	call   4b5 <exit>
 ...
 2f9:	31 db                	xor    %ebx,%ebx
{
 ...
 305:	57                   	push   %edi
 306:	6a 00                	push   $0x0
 308:	e8 c0 01 00 00       	call   4cd <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 36d:	e8 83 01 00 00       	call   4f5 <open>
  if(fd < 0)
 ...
 381:	50                   	push   %eax
 382:	e8 86 01 00 00       	call   50d <fstat>
  close(fd);
 387:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 38a:	89 c6                	mov    %eax,%esi
  close(fd);
 38c:	e8 4c 01 00 00       	call   4dd <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 42b:	e8 20 04 00 00       	call   850 <malloc>
  void * stack;

  //setting up pagealignment
  if (((uint)stackspace % PGSIZE) == 0){
 430:	83 c4 10             	add    $0x10,%esp
 433:	a9 ff 0f 00 00       	test   $0xfff,%eax
 438:	74 05                	je     43f <thread_create+0x1f>
    stack = stackspace;
  }else{
    stack = stackspace + (PGSIZE - ((uint)stackspace - PGSIZE));
 43a:	b8 00 20 00 00       	mov    $0x2000,%eax
  }
 ...
 449:	e8 07 01 00 00       	call   555 <clone>
  if (toret != -1){
    return toret;
  }else {
    return -1;
...
free(void *ap)
{
 ...
 7c1:	a1 c8 0d 00 00       	mov    0xdc8,%eax
{
 ...
 801:	5b                   	pop    %ebx
  freep = p;
 802:	89 15 c8 0d 00 00    	mov    %edx,0xdc8
}
 808:	5e                   	pop    %esi
 809:	5f                   	pop    %edi
 80a:	5d                   	pop    %ebp
 ...
 839:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 83c:	89 15 c8 0d 00 00    	mov    %edx,0xdc8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 859:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 85c:	8b 3d c8 0d 00 00    	mov    0xdc8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 89f:	73 4f                	jae    8f0 <malloc+0xa0>
    ...
    if(p == freep)
 8a1:	8b 3d c8 0d 00 00    	mov    0xdc8,%edi
 ...
 8ca:	e8 f1 fe ff ff       	call   7c0 <free>
  return freep;
 8cf:	8b 15 c8 0d 00 00    	mov    0xdc8,%edx
 ...
 8fc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 8ff:	89 15 c8 0d 00 00    	mov    %edx,0xdc8
}
 ...
 90f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 910:	c7 05 c8 0d 00 00 cc 	movl   $0xdcc,0xdc8
 917:	0d 00 00 
    base.s.size = 0;
 91a:	bf cc 0d 00 00       	mov    $0xdcc,%edi
    base.s.ptr = freep = prevp = &base;
 91f:	c7 05 cc 0d 00 00 cc 	movl   $0xdcc,0xdcc
 926:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 929:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 92b:	c7 05 d0 0d 00 00 00 	movl   $0x0,0xdd0
 932:	00 00 00 
    if(p->s.size >= nunits){
