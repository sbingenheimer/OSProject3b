...
main(int argc, char *argv[])
{
   ...
   ppid = getpid();
  11:	e8 2f 04 00 00       	call   445 <getpid>
  16:	a3 6c 0c 00 00       	mov    %eax,0xc6c

   int fork_pid = fork();
  1b:	e8 9d 03 00 00       	call   3bd <fork>
   if(fork_pid == 0) {
  ...
  2c:	50                   	push   %eax
  2d:	e8 3b 04 00 00       	call   46d <join>
   assert(join_pid == -1);
  ...
  6f:	58                   	pop    %eax
  70:	ff 35 6c 0c 00 00    	push   0xc6c
  76:	e8 7a 03 00 00       	call   3f5 <kill>
  7b:	e8 45 03 00 00       	call   3c5 <exit>
   assert(fork_pid > 0);
  80:	6a 1e                	push   $0x1e
  ...
  9b:	eb b8                	jmp    55 <main+0x55>
     exit();
  9d:	e8 23 03 00 00       	call   3c5 <exit>

   assert(wait() > 0);
  a2:	e8 26 03 00 00       	call   3cd <wait>
  ...
  b4:	e8 77 04 00 00       	call   530 <printf>
   exit();
  b9:	e8 07 03 00 00       	call   3c5 <exit>
   assert(wait() > 0);
  be:	6a 24                	push   $0x24
 ...
 209:	31 db                	xor    %ebx,%ebx
{
 ...
 215:	57                   	push   %edi
 216:	6a 00                	push   $0x0
 218:	e8 c0 01 00 00       	call   3dd <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 27d:	e8 83 01 00 00       	call   405 <open>
  if(fd < 0)
 ...
 291:	50                   	push   %eax
 292:	e8 86 01 00 00       	call   41d <fstat>
  close(fd);
 297:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 29a:	89 c6                	mov    %eax,%esi
  close(fd);
 29c:	e8 4c 01 00 00       	call   3ed <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 33b:	e8 20 04 00 00       	call   760 <malloc>
  void * stack;

  //setting up pagealignment
  if (((uint)stackspace % PGSIZE) == 0){
 340:	83 c4 10             	add    $0x10,%esp
 343:	a9 ff 0f 00 00       	test   $0xfff,%eax
 348:	74 05                	je     34f <thread_create+0x1f>
    stack = stackspace;
  }else{
    stack = stackspace + (PGSIZE - ((uint)stackspace - PGSIZE));
 34a:	b8 00 20 00 00       	mov    $0x2000,%eax
  }
 ...
 359:	e8 07 01 00 00       	call   465 <clone>
  if (toret != -1){
    return toret;
  }else {
    return -1;
...
int thread_join() {
 ...
 369:	50                   	push   %eax
 36a:	e8 fe 00 00 00       	call   46d <join>
    return toret;
  }
  else{
    return -1;
 ...
 48c:	89 d1                	mov    %edx,%ecx
{
 ...
 4fe:	56                   	push   %esi
 4ff:	57                   	push   %edi
 500:	e8 e0 fe ff ff       	call   3e5 <write>
  while(--i >= 0)
 ...
 539:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 575:	57                   	push   %edi
 576:	56                   	push   %esi
 577:	e8 69 fe ff ff       	call   3e5 <write>
 ...
 5ce:	e8 12 fe ff ff       	call   3e5 <write>
        putc(fd, c);
 ...
 5df:	57                   	push   %edi
 5e0:	56                   	push   %esi
 5e1:	e8 ff fd ff ff       	call   3e5 <write>
        putc(fd, c);
 ...
 68c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 68f:	e8 51 fd ff ff       	call   3e5 <write>
        ap++;
...
free(void *ap)
{
 ...
 6d1:	a1 70 0c 00 00       	mov    0xc70,%eax
{
 ...
 711:	5b                   	pop    %ebx
  freep = p;
 712:	89 15 70 0c 00 00    	mov    %edx,0xc70
}
 718:	5e                   	pop    %esi
 719:	5f                   	pop    %edi
 71a:	5d                   	pop    %ebp
 ...
 749:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 74c:	89 15 70 0c 00 00    	mov    %edx,0xc70
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 769:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 76c:	8b 3d 70 0c 00 00    	mov    0xc70,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7af:	73 4f                	jae    800 <malloc+0xa0>
    ...
    if(p == freep)
 7b1:	8b 3d 70 0c 00 00    	mov    0xc70,%edi
 ...
 7c3:	e8 85 fc ff ff       	call   44d <sbrk>
  if(p == (char*)-1)
 ...
 7da:	e8 f1 fe ff ff       	call   6d0 <free>
  return freep;
 7df:	8b 15 70 0c 00 00    	mov    0xc70,%edx
 ...
 80c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 80f:	89 15 70 0c 00 00    	mov    %edx,0xc70
}
 ...
 81f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 820:	c7 05 70 0c 00 00 74 	movl   $0xc74,0xc70
 827:	0c 00 00 
    base.s.size = 0;
 82a:	bf 74 0c 00 00       	mov    $0xc74,%edi
    base.s.ptr = freep = prevp = &base;
 82f:	c7 05 74 0c 00 00 74 	movl   $0xc74,0xc74
 836:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 839:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 83b:	c7 05 78 0c 00 00 00 	movl   $0x0,0xc78
 842:	00 00 00 
    if(p->s.size >= nunits){
