...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	push   (%ebx)
  35:	e8 9b 03 00 00       	call   3d5 <unlink>
  ...
  exit();
  4b:	e8 35 03 00 00       	call   385 <exit>
      printf(2, "rm: %s failed to delete\n", argv[i]);
  50:	50                   	push   %eax
  51:	ff 33                	push   (%ebx)
  53:	68 2c 08 00 00       	push   $0x82c
  58:	6a 02                	push   $0x2
  ...
  6d:	e8 7e 04 00 00       	call   4f0 <printf>
    exit();
  72:	e8 0e 03 00 00       	call   385 <exit>
  77:	66 90                	xchg   %ax,%ax
  79:	66 90                	xchg   %ax,%ax
  7b:	66 90                	xchg   %ax,%ax
  7d:	66 90                	xchg   %ax,%ax
 ...
 1a9:	31 db                	xor    %ebx,%ebx
{
 ...
 1b5:	57                   	push   %edi
 1b6:	6a 00                	push   $0x0
 1b8:	e8 e0 01 00 00       	call   39d <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 21d:	e8 a3 01 00 00       	call   3c5 <open>
  if(fd < 0)
 ...
 231:	50                   	push   %eax
 232:	e8 a6 01 00 00       	call   3dd <fstat>
  close(fd);
 237:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 23a:	89 c6                	mov    %eax,%esi
  close(fd);
 23c:	e8 6c 01 00 00       	call   3ad <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 2db:	e8 40 04 00 00       	call   720 <malloc>
  if (stackspace == NULL){
 2e0:	83 c4 10             	add    $0x10,%esp
 2e3:	85 c0                	test   %eax,%eax
 2e5:	74 28                	je     30f <thread_create+0x3f>
    return -1;
  }
  void * stack;
 ...
 2e7:	a9 ff 0f 00 00       	test   $0xfff,%eax
 2ec:	75 1a                	jne    308 <thread_create+0x38>
  }else{
 ...
 2ee:	50                   	push   %eax
 2ef:	ff 75 10             	push   0x10(%ebp)
 2f2:	ff 75 0c             	push   0xc(%ebp)
 2f5:	ff 75 08             	push   0x8(%ebp)
 2f8:	e8 28 01 00 00       	call   425 <clone>
 ...
 302:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    stack = stackspace + (PGSIZE - ((uint)stackspace - PGSIZE));
 308:	b8 00 20 00 00       	mov    $0x2000,%eax
 30d:	eb df                	jmp    2ee <thread_create+0x1e>
}
 30f:	c9                   	leave  
    return -1;
 ...
 44c:	89 d1                	mov    %edx,%ecx
{
 ...
 479:	0f b6 92 a4 08 00 00 	movzbl 0x8a4(%edx),%edx
 ...
 4be:	56                   	push   %esi
 4bf:	57                   	push   %edi
 4c0:	e8 e0 fe ff ff       	call   3a5 <write>
  while(--i >= 0)
 ...
 4f9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 535:	57                   	push   %edi
 536:	56                   	push   %esi
 537:	e8 69 fe ff ff       	call   3a5 <write>
 ...
 569:	ff 24 85 4c 08 00 00 	jmp    *0x84c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 58e:	e8 12 fe ff ff       	call   3a5 <write>
        putc(fd, c);
 ...
 59f:	57                   	push   %edi
 5a0:	56                   	push   %esi
 5a1:	e8 ff fd ff ff       	call   3a5 <write>
        putc(fd, c);
 ...
 60b:	57                   	push   %edi
 60c:	56                   	push   %esi
 60d:	e8 93 fd ff ff       	call   3a5 <write>
        while(*s != 0){
 ...
 64c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 64f:	e8 51 fd ff ff       	call   3a5 <write>
        ap++;
 ...
 677:	90                   	nop
          s = "(null)";
 678:	ba 45 08 00 00       	mov    $0x845,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 691:	a1 04 0c 00 00       	mov    0xc04,%eax
{
 ...
 6d1:	5b                   	pop    %ebx
  freep = p;
 6d2:	89 15 04 0c 00 00    	mov    %edx,0xc04
}
 6d8:	5e                   	pop    %esi
 6d9:	5f                   	pop    %edi
 6da:	5d                   	pop    %ebp
 ...
 709:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 70c:	89 15 04 0c 00 00    	mov    %edx,0xc04
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 3d 04 0c 00 00    	mov    0xc04,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 76f:	73 4f                	jae    7c0 <malloc+0xa0>
    ...
    if(p == freep)
 771:	8b 3d 04 0c 00 00    	mov    0xc04,%edi
 ...
 783:	e8 85 fc ff ff       	call   40d <sbrk>
  if(p == (char*)-1)
 ...
 79a:	e8 f1 fe ff ff       	call   690 <free>
  return freep;
 79f:	8b 15 04 0c 00 00    	mov    0xc04,%edx
 ...
 7cc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7cf:	89 15 04 0c 00 00    	mov    %edx,0xc04
}
 ...
 7df:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7e0:	c7 05 04 0c 00 00 08 	movl   $0xc08,0xc04
 7e7:	0c 00 00 
    base.s.size = 0;
 7ea:	bf 08 0c 00 00       	mov    $0xc08,%edi
    base.s.ptr = freep = prevp = &base;
 7ef:	c7 05 08 0c 00 00 08 	movl   $0xc08,0xc08
 7f6:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7f9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7fb:	c7 05 0c 0c 00 00 00 	movl   $0x0,0xc0c
 802:	00 00 00 
    if(p->s.size >= nunits){
