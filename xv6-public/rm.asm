...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	push   (%ebx)
  35:	e8 7b 03 00 00       	call   3b5 <unlink>
  ...
  exit();
  4b:	e8 15 03 00 00       	call   365 <exit>
      printf(2, "rm: %s failed to delete\n", argv[i]);
  50:	50                   	push   %eax
  51:	ff 33                	push   (%ebx)
  ...
  6d:	e8 5e 04 00 00       	call   4d0 <printf>
    exit();
  72:	e8 ee 02 00 00       	call   365 <exit>
  77:	66 90                	xchg   %ax,%ax
  79:	66 90                	xchg   %ax,%ax
  7b:	66 90                	xchg   %ax,%ax
  7d:	66 90                	xchg   %ax,%ax
 ...
 1a9:	31 db                	xor    %ebx,%ebx
{
 ...
 1b5:	57                   	push   %edi
 1b6:	6a 00                	push   $0x0
 1b8:	e8 c0 01 00 00       	call   37d <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 21d:	e8 83 01 00 00       	call   3a5 <open>
  if(fd < 0)
 ...
 231:	50                   	push   %eax
 232:	e8 86 01 00 00       	call   3bd <fstat>
  close(fd);
 237:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 23a:	89 c6                	mov    %eax,%esi
  close(fd);
 23c:	e8 4c 01 00 00       	call   38d <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 2db:	e8 20 04 00 00       	call   700 <malloc>
  void * stack;

  //setting up pagealignment
  if (((uint)stackspace % PGSIZE) == 0){
 2e0:	83 c4 10             	add    $0x10,%esp
 2e3:	a9 ff 0f 00 00       	test   $0xfff,%eax
 2e8:	74 05                	je     2ef <thread_create+0x1f>
    stack = stackspace;
  }else{
    stack = stackspace + (PGSIZE - ((uint)stackspace - PGSIZE));
 2ea:	b8 00 20 00 00       	mov    $0x2000,%eax
  }

  //call clone
  int toret = clone(start_routine, arg1, arg2, stack);
 2ef:	50                   	push   %eax
 2f0:	ff 75 10             	push   0x10(%ebp)
 2f3:	ff 75 0c             	push   0xc(%ebp)
 2f6:	ff 75 08             	push   0x8(%ebp)
 2f9:	e8 07 01 00 00       	call   405 <clone>
  if (toret != -1){
    return toret;
  }else {
    return -1;
 ...
 671:	a1 dc 0b 00 00       	mov    0xbdc,%eax
{
 ...
 6b1:	5b                   	pop    %ebx
  freep = p;
 6b2:	89 15 dc 0b 00 00    	mov    %edx,0xbdc
}
 6b8:	5e                   	pop    %esi
 6b9:	5f                   	pop    %edi
 6ba:	5d                   	pop    %ebp
 ...
 6e9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ec:	89 15 dc 0b 00 00    	mov    %edx,0xbdc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 3d dc 0b 00 00    	mov    0xbdc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 74f:	73 4f                	jae    7a0 <malloc+0xa0>
    ...
    if(p == freep)
 751:	8b 3d dc 0b 00 00    	mov    0xbdc,%edi
 ...
 77a:	e8 f1 fe ff ff       	call   670 <free>
  return freep;
 77f:	8b 15 dc 0b 00 00    	mov    0xbdc,%edx
 ...
 7ac:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7af:	89 15 dc 0b 00 00    	mov    %edx,0xbdc
}
 ...
 7bf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7c0:	c7 05 dc 0b 00 00 e0 	movl   $0xbe0,0xbdc
 7c7:	0b 00 00 
    base.s.size = 0;
 7ca:	bf e0 0b 00 00       	mov    $0xbe0,%edi
    base.s.ptr = freep = prevp = &base;
 7cf:	c7 05 e0 0b 00 00 e0 	movl   $0xbe0,0xbe0
 7d6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7d9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7db:	c7 05 e4 0b 00 00 00 	movl   $0x0,0xbe4
 7e2:	00 00 00 
    if(p->s.size >= nunits){
