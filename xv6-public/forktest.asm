...
main(void)
{
  ...
  exit();
   b:	e8 f5 03 00 00       	call   405 <exit>
...
00000010 <printf>:
{
  ...
  28:	e8 f8 03 00 00       	call   425 <write>
}
  ...
  44:	31 db                	xor    %ebx,%ebx
{
  ...
  5c:	6a 01                	push   $0x1
  5e:	e8 c2 03 00 00       	call   425 <write>
  ...
  7b:	0f 84 83 00 00 00    	je     104 <forktest+0xc4>
    pid = fork();
  81:	e8 77 03 00 00       	call   3fd <fork>
    if(pid < 0)
  ...
  8e:	66 90                	xchg   %ax,%ax
    if(wait() < 0){
  90:	e8 78 03 00 00       	call   40d <wait>
  ...
  if(wait() != -1){
  9e:	e8 6a 03 00 00       	call   40d <wait>
  ...
  be:	6a 01                	push   $0x1
  c0:	e8 60 03 00 00       	call   425 <write>
}
  c5:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  c8:	c9                   	leave  
  c9:	c3                   	ret    
      exit();
  ca:	e8 36 03 00 00       	call   405 <exit>
  write(fd, s, strlen(s));
  ...
  e5:	6a 01                	push   $0x1
  e7:	e8 39 03 00 00       	call   425 <write>
      exit();
  ec:	e8 14 03 00 00       	call   405 <exit>
  ...
  fa:	e8 11 ff ff ff       	call   10 <printf>
    exit();
  ff:	e8 01 03 00 00       	call   405 <exit>
 ...
 111:	e8 fa fe ff ff       	call   10 <printf>
    exit();
 116:	e8 ea 02 00 00       	call   405 <exit>
 ...
 249:	31 db                	xor    %ebx,%ebx
{
 ...
 255:	57                   	push   %edi
 256:	6a 00                	push   $0x0
 258:	e8 c0 01 00 00       	call   41d <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2bd:	e8 83 01 00 00       	call   445 <open>
  if(fd < 0)
 ...
 2d1:	50                   	push   %eax
 2d2:	e8 86 01 00 00       	call   45d <fstat>
  close(fd);
 2d7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2da:	89 c6                	mov    %eax,%esi
  close(fd);
 2dc:	e8 4c 01 00 00       	call   42d <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 37b:	e8 d0 01 00 00       	call   550 <malloc>
  void * stack;

  //setting up pagealignment
  if (((uint)stackspace % PGSIZE) == 0){
 380:	83 c4 10             	add    $0x10,%esp
 383:	a9 ff 0f 00 00       	test   $0xfff,%eax
 388:	74 05                	je     38f <thread_create+0x1f>
    stack = stackspace;
  }else{
    stack = stackspace + (PGSIZE - ((uint)stackspace - PGSIZE));
 38a:	b8 00 20 00 00       	mov    $0x2000,%eax
  }

  //call clone
  int toret = clone(start_routine, arg1, arg2, stack);
 38f:	50                   	push   %eax
 390:	ff 75 10             	push   0x10(%ebp)
 393:	ff 75 0c             	push   0xc(%ebp)
 396:	ff 75 08             	push   0x8(%ebp)
 399:	e8 07 01 00 00       	call   4a5 <clone>
  if (toret != -1){
    return toret;
  }else {
    return -1;
...
int thread_join() {
 ...
 3a9:	50                   	push   %eax
 3aa:	e8 fe 00 00 00       	call   4ad <join>
    return toret;
  }
  else{
    return -1;
...
void lock_release(lock_t *lock){
 ...
 3f8:	f0 87 02             	lock xchg %eax,(%edx)
  xchg(&lock->locked, 0);
 3fb:	5d                   	pop    %ebp
 3fc:	c3                   	ret    
...
free(void *ap)
{
 ...
 4c1:	a1 c0 09 00 00       	mov    0x9c0,%eax
{
 ...
 501:	5b                   	pop    %ebx
  freep = p;
 502:	89 15 c0 09 00 00    	mov    %edx,0x9c0
}
 508:	5e                   	pop    %esi
 509:	5f                   	pop    %edi
 50a:	5d                   	pop    %ebp
 ...
 539:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 53c:	89 15 c0 09 00 00    	mov    %edx,0x9c0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 559:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 55c:	8b 3d c0 09 00 00    	mov    0x9c0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 59f:	73 4f                	jae    5f0 <malloc+0xa0>
    ...
    if(p == freep)
 5a1:	8b 3d c0 09 00 00    	mov    0x9c0,%edi
 ...
 5b3:	e8 d5 fe ff ff       	call   48d <sbrk>
  if(p == (char*)-1)
 ...
 5ca:	e8 f1 fe ff ff       	call   4c0 <free>
  return freep;
 5cf:	8b 15 c0 09 00 00    	mov    0x9c0,%edx
 ...
 5fc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 5ff:	89 15 c0 09 00 00    	mov    %edx,0x9c0
}
 ...
 60f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 610:	c7 05 c0 09 00 00 c4 	movl   $0x9c4,0x9c0
 617:	09 00 00 
    base.s.size = 0;
 61a:	bf c4 09 00 00       	mov    $0x9c4,%edi
    base.s.ptr = freep = prevp = &base;
 61f:	c7 05 c4 09 00 00 c4 	movl   $0x9c4,0x9c4
 626:	09 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 629:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 62b:	c7 05 c8 09 00 00 00 	movl   $0x0,0x9c8
 632:	00 00 00 
    if(p->s.size >= nunits){
