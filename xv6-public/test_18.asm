...
main(int argc, char *argv[])
{
   ...
   e:	51                   	push   %ecx
   ppid = getpid();
   f:	e8 b1 05 00 00       	call   5c5 <getpid>

   lock_init(&lock);
  14:	83 ec 0c             	sub    $0xc,%esp
  17:	68 74 0e 00 00       	push   $0xe74
   ppid = getpid();
  ...
  26:	a1 70 0e 00 00       	mov    0xe70,%eax
  ...
  40:	a1 70 0e 00 00       	mov    0xe70,%eax
  ...
  a0:	e8 d0 04 00 00       	call   575 <kill>
  a5:	e8 9b 04 00 00       	call   545 <exit>
   for (i = 0; i < num_threads; i++) {
  ...
  b8:	a1 70 0e 00 00       	mov    0xe70,%eax
 ...
 11d:	e8 8e 05 00 00       	call   6b0 <printf>
   exit();
 122:	e8 1e 04 00 00       	call   545 <exit>
...
worker(void *arg1, void *arg2) {
 ...
 1eb:	e8 85 03 00 00       	call   575 <kill>
 1f0:	e8 50 03 00 00       	call   545 <exit>
    assert(nested_thread_pid > 0);
 1f5:	6a 47                	push   $0x47
