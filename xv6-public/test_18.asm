...
main(int argc, char *argv[])
{
   ...
   e:	51                   	push   %ecx
   ppid = getpid();
   f:	e8 91 05 00 00       	call   5a5 <getpid>

   lock_init(&lock);
  14:	83 ec 0c             	sub    $0xc,%esp
  17:	68 4c 0e 00 00       	push   $0xe4c
   ppid = getpid();
  1c:	a3 54 0e 00 00       	mov    %eax,0xe54
   lock_init(&lock);
  21:	e8 ba 04 00 00       	call   4e0 <lock_init>

   int i;
   for (i = 0; i < num_threads; i++) {
  26:	a1 48 0e 00 00       	mov    0xe48,%eax
  ...
  40:	a1 48 0e 00 00       	mov    0xe48,%eax
  ...
  99:	5b                   	pop    %ebx
  9a:	ff 35 54 0e 00 00    	push   0xe54
  a0:	e8 b0 04 00 00       	call   555 <kill>
  a5:	e8 7b 04 00 00       	call   525 <exit>
   for (i = 0; i < num_threads; i++) {
  ...
  b8:	a1 48 0e 00 00       	mov    0xe48,%eax
  ...
  ec:	3b 05 50 0e 00 00    	cmp    0xe50,%eax
 ...
 11d:	e8 6e 05 00 00       	call   690 <printf>
   exit();
 122:	e8 fe 03 00 00       	call   525 <exit>
...
void worker2(void *arg1,void *arg2){
 ...
 133:	83 ec 14             	sub    $0x14,%esp
    int j;
    lock_acquire(&lock);
 136:	68 4c 0e 00 00       	push   $0xe4c
 13b:	e8 b0 03 00 00       	call   4f0 <lock_acquire>
    for(j=0;j<50;j++);
    global++;
    lock_release(&lock);
 140:	c7 04 24 4c 0e 00 00 	movl   $0xe4c,(%esp)
    global++;
 147:	83 05 50 0e 00 00 01 	addl   $0x1,0xe50
    lock_release(&lock);
 14e:	e8 bd 03 00 00       	call   510 <lock_release>
    exit();
 153:	e8 cd 03 00 00       	call   525 <exit>
...
worker(void *arg1, void *arg2) {
 ...
 164:	83 ec 10             	sub    $0x10,%esp
    ...
    lock_acquire(&lock);
 167:	68 4c 0e 00 00       	push   $0xe4c
 16c:	e8 7f 03 00 00       	call   4f0 <lock_acquire>
    int j;
    for(j = 0; j < 50; j++); // take some time
    global++;
    lock_release(&lock);
 171:	c7 04 24 4c 0e 00 00 	movl   $0xe4c,(%esp)
    global++;
 178:	83 05 50 0e 00 00 01 	addl   $0x1,0xe50
    lock_release(&lock);
 17f:	e8 8c 03 00 00       	call   510 <lock_release>
 ...
 1e4:	59                   	pop    %ecx
 1e5:	ff 35 54 0e 00 00    	push   0xe54
 1eb:	e8 65 03 00 00       	call   555 <kill>
 1f0:	e8 30 03 00 00       	call   525 <exit>
    assert(nested_thread_pid > 0);
 1f5:	6a 47                	push   $0x47
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 4a3:	a9 ff 0f 00 00       	test   $0xfff,%eax
 4a8:	74 05                	je     4af <thread_create+0x1f>
    stack = stackspace;
  }else{
    stack = stackspace + (PGSIZE - ((uint)stackspace - PGSIZE));
 4aa:	b8 00 20 00 00       	mov    $0x2000,%eax
  }

  //call clone
  int toret = clone(start_routine, arg1, arg2, stack);
 4af:	50                   	push   %eax
 4b0:	ff 75 10             	push   0x10(%ebp)
 4b3:	ff 75 0c             	push   0xc(%ebp)
 4b6:	ff 75 08             	push   0x8(%ebp)
 4b9:	e8 07 01 00 00       	call   5c5 <clone>
  if (toret != -1){
    return toret;
  }else {
    return -1;
...
free(void *ap)
{
 ...
 831:	a1 58 0e 00 00       	mov    0xe58,%eax
{
 ...
 871:	5b                   	pop    %ebx
  freep = p;
 872:	89 15 58 0e 00 00    	mov    %edx,0xe58
}
 878:	5e                   	pop    %esi
 879:	5f                   	pop    %edi
 87a:	5d                   	pop    %ebp
 ...
 8a9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 8ac:	89 15 58 0e 00 00    	mov    %edx,0xe58
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 8c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 8cc:	8b 3d 58 0e 00 00    	mov    0xe58,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 90f:	73 4f                	jae    960 <malloc+0xa0>
    ...
    if(p == freep)
 911:	8b 3d 58 0e 00 00    	mov    0xe58,%edi
 ...
 93a:	e8 f1 fe ff ff       	call   830 <free>
  return freep;
 93f:	8b 15 58 0e 00 00    	mov    0xe58,%edx
 ...
 96c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 96f:	89 15 58 0e 00 00    	mov    %edx,0xe58
}
 ...
 97f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 980:	c7 05 58 0e 00 00 5c 	movl   $0xe5c,0xe58
 987:	0e 00 00 
    base.s.size = 0;
 98a:	bf 5c 0e 00 00       	mov    $0xe5c,%edi
    base.s.ptr = freep = prevp = &base;
 98f:	c7 05 5c 0e 00 00 5c 	movl   $0xe5c,0xe5c
 996:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 999:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 99b:	c7 05 60 0e 00 00 00 	movl   $0x0,0xe60
 9a2:	00 00 00 
    if(p->s.size >= nunits){
