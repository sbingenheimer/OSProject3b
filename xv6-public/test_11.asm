   ...
   e:	be 0a 00 00 00       	mov    $0xa,%esi
{
  ...
  15:	83 ec 0c             	sub    $0xc,%esp
   ppid = getpid();
  18:	e8 f8 04 00 00       	call   515 <getpid>
  1d:	a3 b4 0d 00 00       	mov    %eax,0xdb4

   int i, thread_pid, join_pid;
   for(i = 0; i < 10; i++) {
  22:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      global = 1;
  28:	c7 05 b0 0d 00 00 01 	movl   $0x1,0xdb0
  2f:	00 00 00 
  ...
  4c:	e8 df 03 00 00       	call   430 <thread_join>
      assert(join_pid == thread_pid);
  51:	39 c3                	cmp    %eax,%ebx
  53:	0f 85 84 00 00 00    	jne    dd <main+0xdd>
      assert(global == 5);
  59:	a1 b0 0d 00 00       	mov    0xdb0,%eax
...
//	  printf(1, "%d\n", (uint)sbrk(0));
  ...
  6a:	6a 00                	push   $0x0
  6c:	e8 ac 04 00 00       	call   51d <sbrk>
  ...
  cc:	5b                   	pop    %ebx
  cd:	ff 35 b4 0d 00 00    	push   0xdb4
  d3:	e8 ed 03 00 00       	call   4c5 <kill>
  d8:	e8 b8 03 00 00       	call   495 <exit>
  dd:	6a 22                	push   $0x22
...
worker(void *arg1, void *arg2) {
 ...
 143:	83 ec 08             	sub    $0x8,%esp
   assert(global == 1);
 146:	a1 b0 0d 00 00       	mov    0xdb0,%eax
 ...
 185:	59                   	pop    %ecx
 186:	ff 35 b4 0d 00 00    	push   0xdb4
 18c:	e8 34 03 00 00       	call   4c5 <kill>
 191:	e8 ff 02 00 00       	call   495 <exit>
   global += 4;
 196:	a1 b0 0d 00 00       	mov    0xdb0,%eax
 19b:	83 c0 04             	add    $0x4,%eax
 19e:	a3 b0 0d 00 00       	mov    %eax,0xdb0
   exit();
 1a3:	e8 ed 02 00 00       	call   495 <exit>
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 413:	a9 ff 0f 00 00       	test   $0xfff,%eax
 418:	74 05                	je     41f <thread_create+0x1f>
    stack = stackspace;
  }else{
    stack = stackspace + (PGSIZE - ((uint)stackspace - PGSIZE));
 41a:	b8 00 20 00 00       	mov    $0x2000,%eax
  }

  //call clone
  int toret = clone(start_routine, arg1, arg2, stack);
 41f:	50                   	push   %eax
 420:	ff 75 10             	push   0x10(%ebp)
 423:	ff 75 0c             	push   0xc(%ebp)
 426:	ff 75 08             	push   0x8(%ebp)
 429:	e8 07 01 00 00       	call   535 <clone>
  if (toret != -1){
    return toret;
  }else {
    return -1;
...
free(void *ap)
{
 ...
 7a1:	a1 b8 0d 00 00       	mov    0xdb8,%eax
{
 ...
 7e1:	5b                   	pop    %ebx
  freep = p;
 7e2:	89 15 b8 0d 00 00    	mov    %edx,0xdb8
}
 7e8:	5e                   	pop    %esi
 7e9:	5f                   	pop    %edi
 7ea:	5d                   	pop    %ebp
 ...
 819:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 81c:	89 15 b8 0d 00 00    	mov    %edx,0xdb8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 839:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 83c:	8b 3d b8 0d 00 00    	mov    0xdb8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 87f:	73 4f                	jae    8d0 <malloc+0xa0>
    ...
    if(p == freep)
 881:	8b 3d b8 0d 00 00    	mov    0xdb8,%edi
 ...
 8aa:	e8 f1 fe ff ff       	call   7a0 <free>
  return freep;
 8af:	8b 15 b8 0d 00 00    	mov    0xdb8,%edx
 ...
 8dc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 8df:	89 15 b8 0d 00 00    	mov    %edx,0xdb8
}
