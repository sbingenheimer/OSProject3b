   ...
   e:	be 0a 00 00 00       	mov    $0xa,%esi
{
  ...
  15:	83 ec 0c             	sub    $0xc,%esp
   ppid = getpid();
  18:	e8 18 05 00 00       	call   535 <getpid>
  1d:	a3 dc 0d 00 00       	mov    %eax,0xddc

   int i, thread_pid, join_pid;
   for(i = 0; i < 10; i++) {
  22:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      global = 1;
  28:	c7 05 d8 0d 00 00 01 	movl   $0x1,0xdd8
  2f:	00 00 00 
  ...
  53:	0f 85 84 00 00 00    	jne    dd <main+0xdd>
      assert(global == 5);
  59:	a1 d8 0d 00 00       	mov    0xdd8,%eax
...
//	  printf(1, "%d\n", (uint)sbrk(0));
  ...
  6a:	6a 00                	push   $0x0
  6c:	e8 cc 04 00 00       	call   53d <sbrk>
  ...
  84:	50                   	push   %eax
  85:	50                   	push   %eax
  86:	68 b9 09 00 00       	push   $0x9b9
  8b:	6a 01                	push   $0x1
  8d:	e8 8e 05 00 00       	call   620 <printf>
   exit();
  92:	e8 1e 04 00 00       	call   4b5 <exit>
      assert(thread_pid > 0);
  97:	6a 20                	push   $0x20
  99:	68 48 09 00 00       	push   $0x948
  9e:	68 52 09 00 00       	push   $0x952
  a3:	6a 01                	push   $0x1
  a5:	e8 76 05 00 00       	call   620 <printf>
  aa:	83 c4 0c             	add    $0xc,%esp
  ad:	68 87 09 00 00       	push   $0x987
      assert(join_pid == thread_pid);
  b2:	68 66 09 00 00       	push   $0x966
  b7:	6a 01                	push   $0x1
  b9:	e8 62 05 00 00       	call   620 <printf>
  be:	5a                   	pop    %edx
  bf:	59                   	pop    %ecx
  c0:	68 7a 09 00 00       	push   $0x97a
  c5:	6a 01                	push   $0x1
  c7:	e8 54 05 00 00       	call   620 <printf>
  cc:	5b                   	pop    %ebx
  cd:	ff 35 dc 0d 00 00    	push   0xddc
  d3:	e8 0d 04 00 00       	call   4e5 <kill>
  d8:	e8 d8 03 00 00       	call   4b5 <exit>
  dd:	6a 22                	push   $0x22
  df:	68 48 09 00 00       	push   $0x948
  e4:	68 52 09 00 00       	push   $0x952
  e9:	6a 01                	push   $0x1
  eb:	e8 30 05 00 00       	call   620 <printf>
  f0:	83 c4 0c             	add    $0xc,%esp
  f3:	68 96 09 00 00       	push   $0x996
  f8:	eb b8                	jmp    b2 <main+0xb2>
      assert(global == 5);
  fa:	6a 23                	push   $0x23
  fc:	68 48 09 00 00       	push   $0x948
 101:	68 52 09 00 00       	push   $0x952
 106:	6a 01                	push   $0x1
 108:	e8 13 05 00 00       	call   620 <printf>
 10d:	83 c4 0c             	add    $0xc,%esp
 110:	68 ad 09 00 00       	push   $0x9ad
 115:	eb 9b                	jmp    b2 <main+0xb2>
      assert((uint)sbrk(0) < (150 * 4096) && "shouldn't even come close");
 117:	6a 25                	push   $0x25
 119:	68 48 09 00 00       	push   $0x948
 11e:	68 52 09 00 00       	push   $0x952
 123:	6a 01                	push   $0x1
 125:	e8 f6 04 00 00       	call   620 <printf>
 12a:	83 c4 0c             	add    $0xc,%esp
 12d:	68 c8 09 00 00       	push   $0x9c8
...
worker(void *arg1, void *arg2) {
 ...
 143:	83 ec 08             	sub    $0x8,%esp
   assert(global == 1);
 146:	a1 d8 0d 00 00       	mov    0xdd8,%eax
 14b:	83 f8 01             	cmp    $0x1,%eax
 14e:	74 46                	je     196 <worker+0x56>
 150:	6a 2e                	push   $0x2e
 152:	68 48 09 00 00       	push   $0x948
 157:	68 52 09 00 00       	push   $0x952
 15c:	6a 01                	push   $0x1
 15e:	e8 bd 04 00 00       	call   620 <printf>
 163:	83 c4 0c             	add    $0xc,%esp
 166:	68 5a 09 00 00       	push   $0x95a
 16b:	68 66 09 00 00       	push   $0x966
 170:	6a 01                	push   $0x1
 172:	e8 a9 04 00 00       	call   620 <printf>
 177:	58                   	pop    %eax
 178:	5a                   	pop    %edx
 179:	68 7a 09 00 00       	push   $0x97a
 17e:	6a 01                	push   $0x1
 180:	e8 9b 04 00 00       	call   620 <printf>
 185:	59                   	pop    %ecx
 186:	ff 35 dc 0d 00 00    	push   0xddc
 18c:	e8 54 03 00 00       	call   4e5 <kill>
 191:	e8 1f 03 00 00       	call   4b5 <exit>
   global += 4;
 196:	a1 d8 0d 00 00       	mov    0xdd8,%eax
 19b:	83 c0 04             	add    $0x4,%eax
 19e:	a3 d8 0d 00 00       	mov    %eax,0xdd8
   exit();
 1a3:	e8 0d 03 00 00       	call   4b5 <exit>
 ...
 57c:	89 d1                	mov    %edx,%ecx
{
 ...
 5a9:	0f b6 92 64 0a 00 00 	movzbl 0xa64(%edx),%edx
 ...
 629:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 699:	ff 24 85 0c 0a 00 00 	jmp    *0xa0c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 7a7:	90                   	nop
          s = "(null)";
 7a8:	ba 04 0a 00 00       	mov    $0xa04,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 7c1:	a1 e0 0d 00 00       	mov    0xde0,%eax
{
 ...
 801:	5b                   	pop    %ebx
  freep = p;
 802:	89 15 e0 0d 00 00    	mov    %edx,0xde0
}
 808:	5e                   	pop    %esi
 809:	5f                   	pop    %edi
 80a:	5d                   	pop    %ebp
 ...
 839:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 83c:	89 15 e0 0d 00 00    	mov    %edx,0xde0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 859:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 85c:	8b 3d e0 0d 00 00    	mov    0xde0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 89f:	73 4f                	jae    8f0 <malloc+0xa0>
    ...
    if(p == freep)
 8a1:	8b 3d e0 0d 00 00    	mov    0xde0,%edi
 ...
 8ca:	e8 f1 fe ff ff       	call   7c0 <free>
  return freep;
 8cf:	8b 15 e0 0d 00 00    	mov    0xde0,%edx
 ...
 8fc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 8ff:	89 15 e0 0d 00 00    	mov    %edx,0xde0
}
 ...
 90f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 910:	c7 05 e0 0d 00 00 e4 	movl   $0xde4,0xde0
 917:	0d 00 00 
    base.s.size = 0;
 91a:	bf e4 0d 00 00       	mov    $0xde4,%edi
    base.s.ptr = freep = prevp = &base;
 91f:	c7 05 e4 0d 00 00 e4 	movl   $0xde4,0xde4
 926:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 929:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 92b:	c7 05 e8 0d 00 00 00 	movl   $0x0,0xde8
 932:	00 00 00 
    if(p->s.size >= nunits){
